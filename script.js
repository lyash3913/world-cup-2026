...
const playoffMatchesSchedule = {
    ...
    '1/4': [
        { id: 97, date: "Четверг, 9 июля", time: "23:00", stadium: "Бостон • Джиллетт Ст.", team1Code: "fr", team1Text: "Франция", team2Code: "ma", team2Text: "Марокко", prob1: 58, probX: 28, prob2: 14, analysisText:
            `Грандиозная кубковая вывеска, открывающая стадию 1/4 финала чемпионата мира 2026 года. Безоговорочный европейский гранд, сметающий всех на своем пути, сталкивается с главной силой африканского футбола. В Фоксборо нас ожидает невероятное по накалу тактическое противостояние, пропитанное духом реваншизма за полуфинал прошлого мундиаля, где колоссальный класс «Ле Блё» проверит на прочность монументальный марокканский блок.

            ## 1) Общая аналитика

            ### 1. Общая картина
            - **Статус матча:** 1/4 финала — первый поединок четвертьфинальной стадии, где до вожделенного кубка мира остается сделать всего три шага.
            - **Поле и стадион:** США, Бостон/Фоксборо, стадион «Жиллетт Стэдиум». Легендарная арена встретит команды высококлассным натуральным газоном.
            - **Климат:** Начало июля на северо-востоке США характеризуется высокой влажностью и средней температурой воздуха в районе **+26°C...+28°C**. Экстремального зноя нет, но душный воздух потребует от футболистов грамотного и прагматичного распределения физических сил по дистанции матча.
            - **Фаворит:** Франция — безусловный фаворит у букмекеров и футбольных аналитиков. «Ле Блё» обладают монументальным кубковым бэкграундом (чемпионы 1998, 2018; финалисты 2006, 2022). Марокко отвечает на это статусом лучшей команды Африки и сенсационного полуфиналиста ЧМ-2022.
            - **Опыт в чемпионатах:** Французы — признанные короли матчей на выбывание с глубочайшим турнирным опытом. Марокко Валида Реграги уже доказало всему миру свою способность на равных соперничать с любыми элитными сборными в кубковых баталиях.

            ### 2. Рейтинг команд и футболистов
            - **ФИФА:** Франция стабильно удерживает позиции в топ-3 мирового рейтинга. Марокко является безоговорочным лидером африканского континента, располагаясь на высоком 13-м месте.
            - **Рейтинг игроков:** По индивидуальным метрикам и суммарной трансферной стоимости французы значительно превосходят оппонентов. Килиан Мбаппе — один из самых дорогих и опасных игроков планеты. В составе Марокко выделяются исполнители экстра-класса: Ашраф Хакими, Браим Диас и Аззедин Унаи.

            ### 3. Текущая форма на турнире
            - **Франция:** Идеальный и уверенный марш по турнирной дистанции. В 5 матчах на ЧМ-2026 французы добыли 5 побед в основное время при впечатляющей разнице забитых и пропущенных мячей — 14:3.
            - **Марокко:** Демонстрируют максимально организованный и дисциплинированный футбол с явным игровым прогрессом от матча к матчу. Уверенно преодолели сито группового этапа и устроили яркий разгром в первом раунде плей-офф.

            ### 4. Форма и основная статистика
            - **Групповой этап:** Франция в Группе I поочередно переиграла Сенегал (**3:1**), Ирак (**3:0**) и Норвегию (**4:1**), демонстрируя феноменальную атакующую синергию. Марокканцы стабильно набирали очки в своей группе за счет фирменной плотной обороны и стремительных вылетов в контратаки.
            - **Стадия плей-офф (1/32 и 1/16):** Франция в 1/32 финала разбила Швецию (**3:0**), а в 1/16 столкнулась с глухим оборонительным блоком Парагвая (**5-4-1**) и вырвала прагматичную победу **1:0** благодаря пенальти Мбаппе на 70-й минуте. Марокко после 1/32 финала сотворило сенсацию в 1/16, уничтожив сохозяев турнира Канаду со счетом **3:0** (дубль Унаи и гол Рахими на 90+8').

            ### 5. Дополнительная статистика (Тренды)
            - **Владение мячом:** Франция тотально доминирует на поле, удерживая в среднем **58–62%** контроля. Марокко сознательно отдает территорию и инициативу (**42–45%**), уповая на быстрые переходные фазы.
            - **Удары и угловые:** Французы генерируют около **16.5** ударов за игру (**7.2** в створ). У Марокко эти цифры скромнее — **10.4** ударов (**4.1** в створ), но конверсия созданных моментов в последних встречах находится на аномально высоком уровне.
            - **Дисциплина:** Франция действует подчеркнуто чисто — в среднем всего **1.2** желтые карточки за матч. Марокканцы используют агрессивный плотный прессинг, что выливается в обилие предупреждений (в игре с Канадой собрали 4 ЖК: Халхаль, Хакими, Унаи, Эль-Ханнус).

            ### 6. Очные встречи
            - Главный исторический маркер — полуфинал ЧМ-2022 в Катаре. Тогда Франция остановила марокканскую сказку со счетом **2:0** благодаря голам Тео Эрнандеса и Коло Муани. Большинство лидеров с обеих сторон принимали участие в той битве, что добавляет грядущему матчу мощный подтекст реваншизма.

            ### 7. Тактика и стиль игры
            - **Франция (4-2-3-1):** Игра строится на контроле темпа через мощную пару Коне — Рабьо и взрывные фланги. Дидье Дешам использует изоляции для Килиана Мбаппе на левом крыле атаки и смещения Олисе или Дембеле справа. Главная уязвимость — позиционный взлом низких эшелонированных блоков (матч с Парагваем обнажил проблемы при нехватке пространства).
            - **Марокко (4-2-3-1 / 4-5-1):** При переходе в оборонительную фазу схема Валида Реграги трансформируется в ультракомпактный блок. Стиль базируется на интенсивных перехватах в средней зоне и вертикальных передачах на ход Рахими или Эль-Кааби. Сильнейшее оружие — связка Хакими и Диаса на правом фланге.

            ### 8. Составы, травмы и звезды
            - **Франция:** Весь основной костяк находится в строю. Линия обороны Кунде — Упамекано — Салиба — Динь сыгралась эталонно. На скамейке томится роскошная обойма (Тчуамени, Канте, Тюрам), готовая усилить игру под любой тактический сценарий.
            - **Марокко:** Серьезная потеря — полузащитник Исмаэль Сайбари получил повреждение в игре с Канадой и был заменен на 21-й минуте. Вместо него шикарно вписался Суфьян Рахими. Оборону цементирует молодой сыгранный дуэт Халхаль — Диоп при поддержке Мазрауи и Хакими. В воротах незаменим Яссин Буну.

            ### 9. Статистика отдельных игроков
            - **Килиан Мбаппе (Франция):** Главное атакующее оружие «Ле Блё», забивший победный мяч Парагваю и нацеленный на «Золотую бутсу».
            - **Аззедин Унаи (Марокко):** Находится на невероятном игровом пике, продемонстрировав идеальный тайминг подключений из глубины в матче с Канадой.

            ### 10. Настрой и важность матча
            Для Франции любой исход, кроме выхода в полуфинал, станет национальной катастрофой и подвергнется жесткой критике. Для Марокко это исторический шанс повторить и превзойти триумф 2022 года. Статус 1/4 финала диктует предельную осторожность: цена ошибки аномально высока, поэтому команды вряд ли пойдут на неоправданный риск с первых минут.

            ### 11. Тренеры
            - **Дидье Дешам (Франция):** Возглавляет команду с 2012 года, брал ЧМ как игрок и как тренер. Обладает абсолютным авторитетом и гроссмейстерским умением выжимать результат в ключевых кубковых матчах.
            - **Валид Реграги (Марокко):** Тактически гибкий специалист, создавший лучшую оборонительную систему африканского футбола текущего десятилетия. Мастерски заряжает андердогов на футбольные подвиги.

            ### 12. Аналитики и букмекеры
            Вероятность прохода Франции в полуфинал оценивается аналитиками в районе 68–70%. Букмекеры выставили на основное время следующие котировки
            - Победа Франции — **1.71**
            - Ничья — **3.65**
            - Победа Марокко — **5.15**

            ### 13. Ключевые факторы и новости
            Полное отсутствие психологического давления на Марокко — на родине их уже считают национальными героями, что позволяет действовать раскрепощенно. На Францию, напротив, яростно давит пресса, требующая не просто сухого результата, а яркого доминирующего футбола.

            ### 14. Арбитр
            Судейский фактор на этой стадии критичен. Учитывая плотный и жесткий стиль марокканцев в отборе, строгий арбитр с низкой планкой фиксации фолов может быстро посадить опорную зону африканцев на желтые карточки, лишив их агрессии.


            ## 2) Футбольные метрики

            - **Атака:** Франция генерирует колоссальный показатель **xG** — в среднем **2.35** за игру на турнире, хотя против Парагвая цифры просели до **1.42** (с учетом пенальти). Марокко имеет более скромный базовый **xG** (**1.15**), но демонстрирует феноменальную реализацию полумоментов. По ожидаемым ассистам (**xA**) у Франции угроза распределена равномерно между Дембеле, Олисе и Динем (около **0.35** на игрока), в то время как у Марокко вся созидательная мысль идет исключительно через Диаса и Хакими. Показатель **xGOT** (ожидаемые голы в створ) у французов выше за счет точных ударов Мбаппе и Барколя из штрафной, но марокканцы бьют с запредельной плотностью.
            - **Продвижение:** Франция — абсолютный топ. Салиба и Упамекано регулярно продвигают мяч через вертикальные коридоры. У Марокко продвижение завязано на дриблинге Хакими и умных рывках Унаи. Французы совершают в среднем **12** ключевых передач за матч, марокканцы — **6-7**. Прогнозируемый **Field Tilt** (наклон поля) зафиксирует сильный перекос — **65% на 35%** в пользу «Ле Блё». Большинство игрового времени пройдет на трети поля Марокко. Точность передач: Франция держит гроссмейстерские **88–90%**, у Марокко из-за длинных выносов показатель равен **78–81%**.
            - **Защита и прессинг:** У Франции средний индекс **PPDA** равен **10.2** (умеренный сбалансированный прессинг). Марокко без мяча глубоко опускается в низкий блок, позволяя сопернику перепасовываться у своей штрафной, их **PPDA** достигает **14-16**. Однако в момент триггера (прием мяча соперником спиной к воротам) включается сверхагрессивное давление. Пары полузащитников Буадди (или Амрабат) и Эль-Айнауи — лидеры турнира по перехватам во второй трети поля. Франция эффективнее прессингует сразу после потери на чужой половине, Марокко — в финальной трети своей половины.
            - **Комплексные модели (PV / VAEP):** У Франции наивысший ценностный вклад имеют Мбаппе (за счет успешного продвижения на дриблинге в штрафную) и Майк Меньян (точные длинные переводы). В модели **VAEP** у Марокко лидирует Ашраф Хакими, чьи отборы и последующие рывки дают максимальный буст к вероятности гола. Тепловые карты (**Heat Maps**) французов симметричны с уплотнением в левом полуфланге (зона Мбаппе — Барколя), у Марокко — «оборонительный щит» перед своей штрафной и активная вертикальная полоса Хакими справа.


            ## 3) Расчет матча методом Пуассона

            Для расчета взяты очищенные показатели атакующей и оборонительной силы команд на основе матчей ЧМ-2026, скорректированные на силу соперников и кубковый статус четвертьфинала.
            - **Лямбда Франции (ожидаемые голы):** 1.75
            - **Лямбда Марокко (ожидаемые голы):** 0.65
            ...
            **Итог Пуассона:** Общая вероятность победы Франции в основное время составляет **58.5%**, ничейный исход котируется в **23.8%**, победа Марокко — **17.7%**. Модель предрекает вязкий кубковый поединок с явным территориальным преимуществом европейцев.


            ## 4) Поиск в линии VALUE (Честной ставки)

            Оценивая честные коэффициенты на основе модели Пуассона и сравнивая их с букмекерской линией, мы находим несколько явных математических преимуществ для ставок на дистанции.
            - Модель Пуассона оценивает вероятность исхода **Тотал Меньше (2.5)** (сценарии 0:0, 1:0, 2:0, 0:1, 1:1) в **59.5%**, что соответствует честному коэффициенту **1.68**. Если букмекеры предлагают на ТМ (2.5) коэффициент от **1.82** и выше — эта ставка имеет высокую валуйность.
            - Исход **Обе забьют — Нет** (вероятность того, что Марокко не забьет составляет 52.2% плюс сухие сценарии в пользу африканцев) суммарно дает около **63%** вероятности (честный кэф — 1.58). В текущей линии это событие часто можно встретить за валуйные **1.75–1.80**.


            ## 5) Анализ общей информации

            Сборная Франции столкнется со стилистическим двойником Парагвая, но гораздо более высокого игрового класса. Марокко образца матча с Канадой наглядно показало, что умеет терпеть, выжидать и безжалостно наказывать соперника за минимальную потерю концентрации. Франция Дешама не станет форсировать события с первых минут, прекрасно помня о разящем контратакующем потенциале марокканцев. Ключевое тактическое противостояние матча: Мбаппе против Хакими — партнеры по «ПСЖ» досконально знают слабые места друг друга. Франция за счет опыта доставит мяч в финальную треть, но взломать Марокко в первом тайме будет невероятно тяжело. Игра пойдет до первой критической ошибки.


            ## 6) Лучшие ставки на матч

            - **Основной выбор (Надежно):** Тотал меньше (2.5) голов в основное время за коэффициент **1.82**. (Стадия 1/4 финала, тяжелый влажный климат, прагматизм Дешама и монолитная оборонительная структура Марокко превратят матч в шахматную партию. Защита африканцев надежна, а Франция после тяжелых 1:0 с Парагваем будет действовать максимально аккуратно).
            - **Валуйная ставка:** Обе забьют — Нет за коэффициент **1.78**. (Вероятность сухой победы Франции на классе или вязкой нулевой ничьей с переходом в овертайм крайне высока. Оборона французов с Салиба и Упамекано практически не дает сбоев на текущем турнире).
        ...
        { id: 98, date: "Пятница, 10 июля", time: "22:00", stadium: "Лос-Анджелес • Соу-Фай", team1Code: "es", team1Text: "Испания", team2Code: "be", team2Text: "Бельгия", prob1: 46, probX: 30, prob2: 24, analysisText:
            `## 1: ОБЩАЯ АНАЛИТИКА И СИСТЕМНЫЙ РАЗБОР

            ### 1. Общая картина и антураж поединка
            * **Статус и порядковый номер:** Стадия 1/4 финала Чемпионата мира 2026 года. Для обеих национальных сборных это уже 6-й матч на турнире (3 встречи на групповом этапе + 2 в сито плей-офф). Ставки взвинчены до предела: победитель врывается в полуфинал, проигравший — отправляется домой.
            * **Стадион и поле:** Легендарный «Лос-Анджелес Стэдиум» (*SoFi Stadium*, Инглвуд, Калифорния). Сверхсовременная полностью закрытая арена с футуристичной навесной крышей. Специально под жесткие регламентные требования ФИФА искусственное покрытие последнего поколения здесь было полностью заменено на первоклассный натуральный газон. Проблем со скольжением, кочками или дренажем не прогнозируется.
            * **Климатический фактор:** Калифорния, середина июля. Снаружи ожидается классический зной в районе +24...27°C, однако внутри чаши стадиона благодаря уникальной архитектуре навеса и интеллектуальной системе климат-контроля/вентиляции условия будут идеальными для поддержания максимального темпа игры (стабильные +20°C, без осадков и ветра).
            * **Статус фаворита:** Мировые букмекерские конторы и ведущие математические модели (включая платформы *Squawka* и *Kalshi*) единогласно выделяют Испанию как явного фаворита. Шансы на итоговый проход «Красной фурии» в основное время оцениваются примерно в **61–64%**.
            * **Исторический бэкграунд:** Испания — триумфатор мундиаля 2010 года. При этом команда традиционно тяжело преодолевает стадию 1/4 финала (исторически барьер четвертьфинала покорялся испанцам лишь дважды — в 1950 и 2010 годах). Бельгия — бронзовый призер ЧМ-2018. Для «Красных дьяволов» это уже 3-й четвертьфинал за последние 4 чемпионата мира, что подчеркивает их кубковую стабильность.

            ### 2. Табель о рангах и ценность ростеров
            * **Рейтинг FIFA:** Испания монолитно закрепилась в Топ-3 мирового рейтинга благодаря своей феноменальной беспроигрышной серии. Бельгия удерживает позиции в районе 6-8 места, планомерно проходя процесс кадровой перестройки после ухода ключевых фигур своего «золотого поколения».
            * **Класс исполнителей:** По совокупной рыночной стоимости состава Испания ощутимо превосходит Бельгию. Испанские системообразующие игроки (Родри, Ламин Ямаль, Педри) сейчас котируются на пиковых ценовых значениях. У Бельгии главную игровую и медийную ценность по-прежнему представляют Кевин Де Брюйне и Ромелу Лукаку, подкрепленные молодыми звездами в лице Шарля Де Кетеларе и Леандро Троссарда.

            ### 3. Текущая игровая форма команд
            * **🇪🇸 Испания:** Находится на своем историческом футбольном пике. Дружина Луиса де ла Фуэнте повторила великий национальный рекорд — 35 матчей без поражений кряду во всех турнирах. На текущем ЧМ шпанцы выиграли 4 встречи из 5 в основное время при одной ничьей на старте. Вся тактическая структура работает без сбоев.
            * **🇧🇪 Бельгия:** Демонстрирует волнообразную форму. Коллектив под руководством Руди Гарсии играет в непредсказуемый «карусельный» футбол. Бельгийцы тяжело вкатывались в турнир, но к матчу против США поймали кураж. Атакующая линия выглядит грозно, но оборонительные порядки регулярно допускают системные сбои.

            ### 4. Основная статистика турнирного пути на ЧМ-2026
            * **Испания:** 5 матчей — 4 победы, 1 ничья. Общая разница забитых и пропущенных мячей: **8–0**. Фундаментальный факт текущего мундиаля: Испания не пропустила ни одного гола за 5 поединков (5 «сухих» матчей подряд, включая стадию плей-офф). Команда забивает в среднем 1.6 гола за игру, демонстрируя запредельный прагматизм и тотальный контроль темпа.
            * **Бельгия:** 5 матчей — 3 победы, 2 ничьих (с учетом триумфа в овертайме). Разница мячей: **13–7**. Бельгийцы забивают аномально много (в среднем 2.6 гола за поединок), но при этом стабильно пропускают практически в каждой игре (единственное исключение — матч против скромной Новой Зеландии).

            ### 5. Дополнительная статистика и микротренды
            * **Владение мячом:** Испания традиционно доминирует по этому показателю (**62%**) против (**54%**) у Бельгии. Испанцы заберут центр поля под свой контроль.
            * **Удары (всего / в створ):** Испания наносит в среднем **16.4** ударов (**8.2** в створ) за 90 минут. Бельгия отвечает показателями **14.8** ударов (**6.5** в створ). При этом конверсия ударов в голы у бельгийцев чуть выше за счет фактора присутствия Лукаку.
            * **Стандарты (Угловые):** Испания подает очень много (в среднем **6.8** за матч) из-за сверхактивной фланговой игры Ямаля и Кукурельи. У Бельгии этот показатель скромнее — **5.2** за матч.
            * **Дисциплинарная карта:** У обоих коллективов зафиксирован крайне низкий средний показатель грубости (**1.2** и **1.5** желтых карточек за игру). Обе команды делают ставку на умный позиционный прессинг, а не на тактику мелкого фола.

            ### 6. История очных встреч (Head-to-Head)
            На Чемпионатах мира исторический баланс между соперниками абсолютно равен (**1:1**):
            * **1986 год (1/4 финала):** Бельгия прошла Испанию в драматичной серии пенальти (5:4) после боевой ничьей 1:1 в основное время.
            * **1990 год (Групповой этап):** Испания взяла уверенный реванш со счетом 2:1.
            * *Современный контекст:* Последние товарищеские встречи и поединки в рамках Лиги Наций чаще оставались за более техничной и тактически гибкой Испанией, которая успешно нейтрализовала контратакующий потенциал бельгийцев.

            ### 7. Тактико-стратегический рисунок и фишки
            * **Испания (4-3-3):** Классический контроль мяча, но со здоровой вертикализацией. В действиях команды больше нет стерильного владения («тика-така» ради «тика-таки»). Главная фишка — взрывная игра молодых флангов (Ламин Ямаль справа) при железной подстраховке и распределении мяча от Родри в опорной зоне. Главная сильная сторона: безупречная структура контрпрессинга, не позволяющая сопернику организованно выйти из обороны.
            * **Бельгия (4-2-3-1 или 4-3-3):** Руди Гарсия строит строго вертикальный, скоростной контратакующий футбол. Тактическая фишка — позиция Шарля Де Кетеларе, который глубоко опускается в полузащиту и освобождает свободные зоны для реактивных врываний Троссарда и Лукебакио, пока Ромелу Лукаку мощно связывает центральных защитников соперника. Главная уязвимость: пара центрбеков Мехеле — Нгой медлительна и совершает позиционные ошибки при быстрых разворотах атаки оппонента.

            ### 8. Составы, травмы и кадровая ротация
            * **Испания:** Стартовый ростер оптимален, потерь нет. Ожидается выход сильнейших: Унаи Симон; Порро, Кубарси, Лапорт, Кукурелья; Родри, Педри, Дани Ольмо; Ламин Ямаль, Баэна, Ойарсабаль. Нападающий Микель Ойарсабаль находится в огне (4 гола на турнире). Дисквалификации отсутствуют.
            * **Бельгия:** Наличие Тибо Куртуа в створе ворот — гигантский плюс для надежности. В оборонительной линии выйдут Кастань, Мехеле, Нгой, Де Кюипер. Блок полузащиты: Тилеманс, Раскин, Онана. Нападающие: Лукебакио, Де Кетеларе, Троссард. При этом Лукаку может как выйти с первых минут, так и остаться мощным джокером на второй тайм в зависимости от итогового плана Гарсии на игру без мяча. Все лидеры в строю.

            ### 9. Индивидуальный перформанс ключевых игроков
            * **Микель Ойарсабаль (Испания):** Лучший бомбардир команды на ЧМ (4 гола). Демонстрирует феноменальную реализацию моментов, идеально действуя на позиции ложной девятки или инсайда.
            * **Родри (Испания):** Главный теневой претендент на «Золотой мяч». Монолитный держатель структуры игры, показывающий невероятные **94%** точности передач под агрессивным прессингом.
            * **Ромелу Лукаку (Бельгия):** Оформил 3 гола на текущем турнире, сравнявшись по общему числу забитых мячей на ЧМ с легендарными Марадоной и Ривалдо (8 голов в сумме). Главный физический доминант в штрафной площади.
            * **Кевин Де Брюйне (Бельгия):** Его колоссальный кубковый опыт и радиоуправляемые обостряющие передачи — ключевое тактическое оружие Бельгии на стандартах и в переходных фазах.

            ### 10. Мотивационный и ментальный вектор
            Классический формат матча «пан или пропал» (*Win-or-go-home*). Стадия 1/4 финала ментально сложна для Испании исторически, однако текущее молодое поколение игроков полностью лишено «комплекса неудачников» прошлых лет. Для Бельгии это, очевидно, самый последний шанс для заслуженных ветеранов (Де Брюйне, Куртуа, Лукаку) зацепить золото чемпионата мира. Мотивация запредельная — «последний танец». Важность первого гола колоссальна: если Испания забьет первой, она хладнокровно перекроет сопернику кислород за счет стерильного контроля. Если забьет Бельгия — мы увидим вскрытие лучшей обороны мира.

            ### 11. Тренерская дуэль
            * **Луис де ла Фуэнте (Испания):** Триумфально выиграл Евро-2024 и Лигу Наций. Досконально знает молодежь, так как долго работал в структуре юношеских сборных. Пользуется абсолютным доверием федерации. Мастерски перестраивает тактический рисунок прямо по ходу матча.
            * **Руди Гарсия (Бельгия):** Был назначен для прагматичной перестройки команды. Имеет богатый опыт побед на клубном уровне (золото Лиги 1 с «Лиллем»), но на уровне национальных сборных это его первый серьезный вызов. Карьерные перспективы напрямую зависят от выхода в полуфинал. Пока справляется за счет характера игроков.

            ### 12. Аналитический консенсус рынка
            Эксперты сходятся во мнении: Испания за счет баланса линий заберет мяч и будет методично расшатывать фланги бельгийцев. Обозреватели ФИФА отдельно отмечают, что уязвимость Бельгии на флангах обороны (зона Де Кюипера) — это идеальная мишень для дриблинга Ламина Ямаля. При этом букмекеры дают явный перекос в сторону низового матча из-за оборонительной мощи испанцев.

            ### 13. Логистический контекст
            Политического или медийного давления на команды нет. Важный фактор — логистика внутри США. Матч примет Лос-Анджелес. Бельгия свой прошлый поединок проводила в Сиэтле (перелет короткий), Испания — летела из Далласа. Обе сборные имели достаточно времени на полноценное восстановление (матчи 1/8 финала прошли 5-6 июля, четвертьфинал назначен на 10 июля).

            ### 14. Судейский фактор
            Судейская бригада официально утверждается ФИФА за 48 часов до стартового свистка. Ожидается строгий арбитраж от авторитетной европейской или южноамериканской бригады. Испания под давлением судейских решений не плывет, в то время как бельгийцы (особенно Лукаку и Онана) часто сваливаются на апелляции к арбитрам, что может привести к ранним желтым карточкам в центре поля.


            ## 2: ФУТБОЛЬНЫЕ МЕТРИКИ

            *Все продвинутые статистические параметры смоделированы и нормализованы на 90 минут игрового времени против равного соперника на основе структуры матчей ЧМ-2026.*

            * **xG / xA / xGOT (Ожидаемые события):**
            * Испания генерирует в среднем **1.95 xG** за матч. Их моменты структурно «чище», команда практически не бьет из неподготовленных позиций. Бельгия имеет более высокий показатель накопленного xG (**2.30**), но этот параметр искусственно разогнан за счет разгрома США и эмоционального камбэка с Сенегалом.
            * По метрике ожидаемых ассистов (xA) у Испании лидеры — Ямаль и Дани Ольмо (суммарно около **0.65** за игру). У Бельгии практически весь xA держится на гении Де Брюйне (**0.45** индивидуально за матч).
            * Параметр xGOT (ожидаемые голы с учетом створа) у Испании полностью совпадает с xG (**1.90**), что говорит о великолепной точности ударов (Ойарсабаль бьет наверняка). У Бельгии xGOT чуть ниже xG, так как Лукаку часто бьет из убойных позиций прямо во вратаря или защитников.
            * **Progressive Passes / Runs (Продвижение мяча):**
            * Испания — безоговорочный лидер текущего мундиаля. Родри и Кубарси продвигают мяч через центр на **320+** метров за матч. Забеги Ямаля в финальную треть — **8.4** за игру. У Бельгии продвижение идет в основном через фланговые рывки Лукебакио и забросы Де Брюйне.
            * **Key Passes (Ключевые передачи):**
            * Испанцы ощутимо впереди по числу передач под удар за 90 минут — **14** против **9** у бельгийцев.
            * **Field Tilt (Наклон поля / Территориальное доминирование):**
            * У Испании этот показатель составляет рекордные **68%** (игра почти полностью проходит на трети поля соперника). У Бельгии — **51%** (они сознательно отдают территорию в играх с топ-соперниками, как это было в матче с Сенегалом).
            * **Pass Completion Rate (Точность передач):**
            * Испания демонстрирует филигранные **91.5%** точности паса (лучший показатель на турнире). Бельгия держит планку на отметке **84.2%**.
            * **PPDA (Интенсивность прессинга):**
            * Испания имеет удушающий, мгновенный прессинг при потере — PPDA равен **7.8**. Соперник не может сделать и 8 передач на своей половине поля. У Бельгии PPDA составляет **12.4** (средний блок, Гарсия предпочитает встречать оппонента на своей половине поля).
            * **Interceptions & Recoveries (Перехваты и подборы):**
            * Бельгия совершает заметно больше перехватов в своей штрафной (Онана и Мехеле — в топе турнира), так как они больше обороняются низким блоком. Испания делает возвраты мяча (Recoveries) преимущественно в средней зоне и на чужой половине (зона ответственности Родри — Педри).
            * **Successful Pressures (Успешность давления):**
            * У Испании зафиксировано **38%** успешности прессинг-действий. У Бельгии этот параметр равен **26%**.
            * **Комплексные модели оценки (PV / VAEP & Heat Maps):**
            * У Испании наивысший индекс ценности владений имеют действия Родри (переводы на фланги) и Ямаля (дриблинг с продвижением). Каждое действие Ямаля обостряет угрозу гола на **+0.08**. У Бельгии аномально высокий VAEP у Кевина Де Брюйне за счет его точнейших кроссов.
            * Тепловые карты (Heat Maps) наглядно показывают, что тепловая карта Испании — это жирные красные зоны на флангах атаки и монолитное пятно Родри в центральном круге. Тепловая карта Бельгии — глубокое присутствие в своей штрафной и узкая полоса контратак по правому флангу через Лукебакио.


            ## 3: РАСЧЕТ МАТЧА МЕТОДОМ ПУАССОНА

            Для моделирования использованы средние показатели забитых и пропущенных голов на турнире с обязательной поправкой на уровень оппозиции в плей-офф
            * **Испания:** Атака = **1.60**, Оборона = **0.00**. С учетом атакующей силы Бельгии, ожидаемый оборонительный рейтинг Испании скорректируем до **0.40**.
            * **Бельгия:** Атака = **2.60**, Оборона = **1.40**. С учетом железной обороны Испании, атака Бельгии урезается до **0.80**.
            ...
            | Сборная | 0 голов | 1 гол | 2 гола | 3 гола |
            | :--- | :--- | :--- | :--- | :--- |
            | **Испания** | 17.3% | 30.4% | 26.6% | 15.5% |
            | **Бельгия** | 52.2% | 33.9% | 11.0% | 2.4% |

            Итоговые вероятности исходов на основное время (90 минут):
            * **Победа Испании:** **62.8%**
            * **Ничья (включая 0:0, 1:1):** **21.4%**
            * **Победа Бельгии:** **15.8%**


            ##  4: ПОИСК VALUE В БУКМЕКЕРСКОЙ ЛИНИИ

            Сравниваем полученные математические расчеты с текущим рынком ставок 

            1. **Исход: Победа Испании (П1)**
            Рынок дает коэффициент **1.61** (что соответствует вероятности 62.1%). Наш Пуассон показывает **62.8%**. Value нейтральное или минимальное. Ставка абсолютно честная, выраженного валуя нет.
            2. **Исход: Обе забьют — НЕТ**
            Букмекеры дают коэффициент **1.94** ( probability $\rightarrow$ 51.5%). Наш расчет вероятности того, что Бельгия не забьет (52.2%) + сценарии, где Испания уйдет с поля без гола, дает суммарную вероятность «ОЗ - Нет» в районе **58%**. **Здесь есть ощутимое VALUE.** Рынок сильно недооценивает способность Испании засушить атаку Бельгии.
            3. **Исход: Тотал Меньше 2.5 (ТМ 2.5)**
            Наш Пуассон дает высокую вероятность счетов 1:0, 2:0 и 1:1. Суммарная вероятность ТМ 2.5 составляет около **56%** (честный коэффициент должен быть 1.78). Если букмекеры дают в линии выше **1.85** — это очевидное **VALUE**.


            ##  5: АНАЛИЗ ОБЩЕЙ ИНФОРМАЦИИ И РЕЗЮМЕ

            В данном четвертьфинале встречаются две абсолютно противоположные ментальности этого ЧМ. Испания — это синоним тотального контроля, безупречной системности и абсолютной мощи в оборонительной фазе (0 пропущенных мячей за 5 матчей). Они буквально удушают соперника прессингом (PPDA 7.8) и не дают дышать на протяжении всех 90 минут.

            Бельгия — это организованный хаос, характер и яркое индивидуальное мастерство лидеров. Они могут гореть 0:2 Сенегалу, вырывать победу 3:2, а затем на кураже разносить США 4:1. Однако системно их оборонительная линия (Мехеле, Нгой) совершенно не готова к давлению уровня Ламина Ямаля и Дани Ольмо. 

            Позиционное доминирование Испании (Field Tilt 68%) неизбежно заставит Бельгию сидеть глубоко у своих ворот. Без мяча Де Брюйне и Лукаку теряют до 50% своей атакующей эффективности. Матч будет развиваться по сценарию тотального контроля Испании. Ключевой фактор встречи — сможет ли Бельгия выстоять первые 30 минут без пропущенного гола. Если нет — Испания хладнокровно закроет игру.


            ##  6: ЛУЧШИЕ СТАВКИ НА МАТЧ

            На основе глубокого математического и тактического анализа, лучшими выборами с точки зрения соотношения риска и Value являются:

            * **🎯 Основной выбор (Value): Обе забьют — Нет (ОЗ - Нет) за коэффициент 1.94.**
            Испанская оборона на этом турнире безупречна, а Бельгии будет крайне тяжело организовать качественные и чистые контратаки в условиях удушающего контрпрессинга Родри.
            * **🎯 Надежный выбор (Для экспресса / ординара): Итоговый проход Испании за коэффициент 1.35.**
            Даже в случае ничейного исхода в основное время, глубина состава, физическая форма и класс Испании в экстра-таймах или в серии пенальти (где у них есть ментальный гигант Унаи Симон) делают их железными фаворитами.
            * **🎯 Трендовый / Статистический выбор: Тотал матча Меньше 2.5 за коэффициент 1.85.**
            Четвертьфиналы Чемпионатов мира редко бывают открытыми и безрассудными, а игровой стиль Испании направлен на максимальную минимизацию рисков. Прагматичные счета 1:0 или 2:0 в пользу Ла Рохи наиболее вероятны математически.`
        ...
        { id: 99, date: "Воскресенье, 12 июля", time: "00:00", stadium: "Майами • Хард Рок", team1Code: "no", team1Text: "Норвегия", team2Code: "gb-eng", team2Text: "Англия", prob1: 24, probX: 31, prob2: 45, analysisText:
            ...
            ### 1. Общая картина
            - **Статус матча:** 1/4 финала — второй поединок четвертьфинальной стадии, где на кону стоит путевка в заветный полуфинал мирового первенства.
            - **Поле и стадион:** США, Майами-Гарденс, стадион «Хард Рок Стэдиум» («Майами Стэдиум»). Арена встретит футболистов качественным натуральным покрытием.
            - **Климат:** Июль во Флориде несет экстремальные погодные условия — удушающая жара в районе **+31°C...+33°C** в сочетании с высочайшей тропической влажностью и риском ливней. Это неизбежно заставит тренерские штабы строго дозировать интенсивность прессинга.
            - **Фаворит:** Номинальным фаворитом пары выступает сборная Англии (финалисты Евро-2020, 2024), обладающая колоссальным кубковым опытом глубоких стадий. Однако Норвегия уже примерила на себя статус главного возмутителя спокойствия, впервые в истории забравшись так далеко и доказав способность побеждать титанов.
            - **Опыт в чемпионатах:** Британцы привыкли к жесточайшему давлению плей-офф больших турниров. Скандинавы же полностью сбросили с себя ментальный груз и компенсируют дефицит опыта невероятным эмоциональным подъемом.

            ### 2. Рейтинг команд и футболистов
            - **ФИФА:** Англия стабильно удерживает позиции в топ-5 мирового рейтинга. Норвегия находится значительно ниже (за пределами топ-20), но их реальный перформанс на текущем турнире кратно превосходит формальную позицию.
            - **Рейтинг игроков:** Ростер англичан является одним из самых дорогостоящих на планете (Беллингем, Кейн, Сака, Фоден). У Норвегии наблюдается заметный дисбаланс: на острие действует лучший чистый форвард мира Эрлинг Холанд, в центре созидает Мартин Эдегор, но оборонительная линия по именам и рейтингам существенно уступает британской.

            ### 3. Текущая форма на турнире
            - **Англия:** Демонстрирует характер и высочайший атакующий класс, но испытывает очевидные проблемы с игровой дисциплиной и надежностью обороны под сильным системным давлением.
            - **Норвегия:** Находится на пике эмоциональных и физических кондиций. Сборная поймала идеальную волну, а их ключевой страйкер исправно штампует забитые мячи в каждом поединке.

            ### 4. Форма и основная статистика
            - **Групповой этап:** Англия спокойно и прагматично первенствовала в своей группе, набрав дежурные очки (включая сухую победу **2:0** над Панамой). Норвежцы квалифицировались в плей-офф со скрипом (в том числе крупно уступив Франции **1:4**), но провели образцовую работу над ошибками.
            - **Стадия плей-офф (1/32, 1/16 и 1/8):** Англия в 1/16 финала перевернула матч с ДР Конго (**2:1**) благодаря дублю Кейна в концовке, а в 1/8 выдала триллер с Мексикой (**3:2**): быстрый дубль Беллингема и пенальти Кейна принесли успех вопреки красной карточке. Норвегия сотворила сенсацию в 1/8 финала, выбив саму Бразилию (**2:1**) усилиями оформившего дубль Холанда.

            ### 5. Дополнительная статистика (Тренды)
            - **Владение мячом:** Англия при Томасе Тухеле стремится диктовать свои условия через контроль мяча (**55-60%**). Норвегия предпочитает играть вертикально и быстро — для создания моментов им вполне хватает **40-44%** владения.
            - **Удары и реализация:** Британцы демонстрируют отличную конверсию подходов усилиями Кейна и Беллингема. Норвежцы бьют несколько реже, но практически любая адресная доставка мяча на Холанда в штрафную превращается в катастрофу для соперника.
            - **Дисциплина:** Главная уязвимость Англии прямо сейчас. Тяжелейшая эмоциональная битва против мексиканцев оставила команду с ворохом предупреждений и потерей ключевого исполнителя.

            ### 6. Очные встречи
            - В новейшей футбольной истории на уровне мужских сборных команды не пересекались на крупных турнирах с ЧМ-1994 (куда Англия не поехала как раз из-за поражения от норвежцев в квалификации). Товарищеские матчи 2012 и 2014 годов завершились минимальными победами англичан (дважды по **1:0**). Исторический контекст здесь минимален.

            ### 7. Тактика и стиль игры
            - **Англия (4-2-3-1 / 3-4-2-1):** Модель Тухеля нацелена на строгий контроль игровой структуры. Главная фишка — активное насыщение зон между линиями за счет Беллингема и Фодена. Ключевая слабость — уязвимость перед резкими контратаками и мощным силовым давлением.
            - **Норвегия (4-3-3 / 4-4-2 ромб):** Система Столе Сольбаккена заточена под перехват мяча плотным полузащитным блоком во главе с Эдегором и мгновенный запуск вертикальных передач на ход Холанду. Сильнейшая сторона — стандарты и быстрые выпады; слабая — позиционная оборона против техничных вингеров.

            ### 8. Составы, травмы и звезды
            - **Англия:** Огромная потеря в защитной линии — из-за удаления в игре с Мексикой дисквалифицирован центральный защитник Джарелл Куанса. Тухелю придется экстренно перекраивать блок. Джордан Пикфорд повторит рекорд по матчам за сборную на ЧМ. В обойме атаки готовы выйти Сака, Рашфорд, Гордон.
            - **Норвегия:** Состав полностью сыгран и готов к бою. Связка Эдегор — Холанд находится в идеальном тонусе. Защитная линия Берг — Остигард столкнется с максимальной нагрузкой, но кадровых потерь среди лидеров у скандинавов нет.

            ### 9. Статистика отдельных игроков
            - **Эрлинг Холанд (Норвегия):** Лидирует в гонке за «Золотую бутсу» с 7 голами на ЧМ-2026 (деля строчку с Мбаппе и Месси), демонстрируя аномальную реализацию.
            - **Джуд Беллингем (Англия):** Настоящий мотор сборной, способный переворачивать игры в одиночку, что доказал его перформанс против Мексики.
            - **Гарри Кейн (Англия):** Установил новый снайперский рекорд страны на ЧМ. Его умение глубоко опускаться за мячом станет важным фактором взлома скандинавских редутов.

            ### 10. Настрой и важность матча
            Для Англии любой вылет на этой стадии приравнивается к национальному провалу. Для Норвегии — это важнейший матч в истории мужского футбола, они уже прыгнули выше головы. В четвертьфинале обе команды начнут осторожно: Тухель вынужден застегнуть игру на все пуговицы из-за потери Куансы, а Норвегия предпочтет выжидать английских ошибок.

            ### 11. Тренеры
            - **Томас Тухель (Англия):** Элитный кубковый тактик, бравший Лигу чемпионов. Мастерски подстраивает систему под конкретные уязвимости оппонента.
            - **Столе Сольбаккен (Норвегия):** Выстроил вокруг своих суперзвезд жесткую, дисциплинированную команду, беспрекословно выполняющую игровой план.

            ### 12. Аналитики и букмекеры
            Вероятность прохода Англии оценивается в районе 62–64%. При этом котировки на чистую победу фаворита в основное время подросли из-за кадровых проблем британцев в обороне
            - Победа Англии — **1.82**
            - Ничья — **3.55**
            - Победа Норвегии — **4.40**

            ### 13. Ключевые факторы и новости
            Англичане оставили слишком много сил и эмоций в высокогорном Мехико под свист трибун. Тяжелый перелет в душный Майами и дисквалификация защитника — главные негативные новости для «Трех Львов». Норвежцы планомерно готовились в более комфортных условиях и готовы функционально лучше.

            ### 14. Арбитр
            Судейство ожидается строгим — ФИФА назначает на четвертьфиналы лучших рефери. Для Норвегии критически важно избегать необязательных фолов близ своей штрафной, так как стандарты Англии при участии Кейна и Беллингема смертельно опасны.


            ## 2) Футбольные метрики

            - **Атака:** Англия имеет средний **xG** на уровне **1.95** за игру, выжав максимум против Мексики. Норвегия демонстрирует более низкий командный **xG** (около **1.30**), однако индивидуальный показатель Холанда составляет почти **70%** от общекомандного. Эрлинг регулярно забивает голы с полумоментов, существенно оверперформируя метрику. По ожидаемым ассистам (**xA**) у Англии угроза распределена равномерно (Фоден, Райс, крайние защитники), тогда как у Норвегии безоговорочный лидер — Мартин Эдегор (**0.42** потенциальных ассиста за 90 минут). Показатель **xGOT** ударов Холанда и Кейна традиционно высок — оба форварда бьют прицельно в углы.
            - **Продвижение:** Джон Стоунз и Деклан Райс — лидеры Англии по продвижению мяча через пасы. У Норвегии продвижение завязано на фланговых рывках Нусы или вертикальных передачах Эдегора из центрального круга. Англия делает до **14** ключевых передач за матч, Норвегия — около **8**, но их пасы более вертикальны и направлены сразу в финальную треть. Прогнозируемый **Field Tilt** (наклон поля) — **57% на 43%** в пользу Англии. Скандинавы за счет класса Эдегора не позволят прижать себя к воротам. Точность передач: Англия держит высокий уровень в **86-88%**, Норвегия рискует чаще, поэтому их точность ниже — около **78%**.
            - **Защита и прессинг:** Англия Тухеля применяет качественный зонный прессинг со средним индексом **PPDA ~ 11.0**. Норвегия в победной игре с Бразилией показала очень низкий **PPDA (15.2)** — они сознательно позволяли сопернику переходить центральную линию, встречая его плотным блоком в оборонительной трети. Против Англии скандинавы выберут схожую модель. Опорники Берг и Торстведт выполняют огромный объем черновой работы. Англия традиционно сильна в контрпрессинге — возврате мяча в течение 5 секунд после потери.
            - **Комплексные модели (PV / VAEP):** У Англии наивысший балл по модели **VAEP** имеет Джуд Беллингем благодаря действиям, продвигающим атаку в штрафную. У Норвегии вне конкуренции находится Холанд (каждое его касание критически поднимает вероятность гола) и Эдегор (за счет созидательных пасов). Тепловые карты (**Heat Maps**) Англии зафиксируют высокую активность в полуфлангах на подступах к штрафной, норвежская карта выделит два пятна: центральный круг (зона обитания Эдегора при билд-апе) и вратарская площадь соперника (зона Холанда).


            ## 3) Расчет матча методом Пуассона

            Для расчета взяты очищенные показатели атакующей и оборонительной силы команд на ЧМ-2026 с учетом кадровых проблем Англии в защите и феноменальной формы Холанда.
            - **Лямбда Англии (ожидаемые голы):** 1.60
            - **Лямбда Норвегии (ожидаемые голы):** 1.10
            ...
            **Итог Пуассона:** Вероятность победы Англии в основное время составляет **48.2%**, ничейный исход котируется в **24.3%**, победа Норвегии — **27.5%**. Математическая модель прогнозирует максимально плотный и обоюдоострый поединок.


            ## 4) Поиск в линии VALUE (Честной ставки)

            Сравнивая пуассоновские вероятности с рыночными коэффициентами букмекеров, мы находим несколько очевидных математических преимуществ для ставок на дистанции.
            - Модель оценивает вероятность «верхового» матча (**Тотал Больше 2.5**) примерно в **51.5%**, что дает честный коэффициент **1.94**. Букмекеры, помня о кубковом прагматизме Тухеля, часто завышают кэф на ТБ (2.5) до **2.10–2.15**. Это чистый Валуй — ослабленная оборона Англии и наличие Холанда гарантируют голы.
            - Исход **Обе забьют — Да** имеет честную вероятность по модели в **53.5%** (кэф **1.87**). Если в линии на это дают **2.00** и выше, ставку необходимо забирать. Без Куансы удержать ворота Пикфорда сухими против Холанда будет почти невозможно.


            ## 5) Анализ общей информации

            Этот четвертьфинал обещает быть гораздо более открытым и результативным, чем пара Франция — Марокко. Англия обладает колоссальным атакующим потенциалом, но потеря сыгранного центрального защитника Куансы против лучшего форварда мира Холанда — это критический фактор. Томас Тухель наверняка попытается минимизировать риск, заставив Райса играть глубже, ближе к защитникам, чтобы перекрывать кислород Эдегору. Норвегия не станет прижиматься к своим воротам слишком низко. Ключевая дуэль матча: Джон Стоунз против Эрлинга Холанда — партнеры по «Манчестер Сити» знают друг друга до мельчайших нюансов. Опыт Англии должен сказаться, но легкой прогулки для них не будет.


            ## 6) Лучшие ставки на матч

            - **Основная ставка (Надежно):** Обе забьют — Да за коэффициент **2.02**. (Оборона Англии стабильно пропускала и от Конго, и от Мексики, а теперь лишилась основного защитника. Холанд свой шанс обязательно найдет. В то же время атака англичан слишком сильна, чтобы уйти с поля без забитого мяча).
            - **Валуйная ставка:** Тотал больше (2.5) голов в основное время за коэффициент **2.12**. (Математическая модель указывает на явную недооценку букмекерами атакующего потенциала этой пары на стадии четвертьфинала. Жара может снизить темп, но исполнительское мастерство лидеров превращает полумоменты в голы).
        ...
        { id: 100, date: "Воскресенье, 12 июля", time: "04:00", stadium: "Канзас-Сити • Эрроухед", team1Code: "ar", team1Text: "Аргентина", team2Code: "ch", team2Text: "Швейцария", prob1: 59, probX: 27, prob2: 14, analysisText:
            `## 1: ОБЩАЯ АНАЛИТИКА И СИСТЕМНЫЙ РАЗБОР

            ### 1. Общая картина и антураж поединка
            * **Статус и порядковый номер:** Стадия 1/4 финала Чемпионата мира 2026 года. Для обеих команд это 6-й поединок на турнире. Национальные сборные успешно преодолели тяжелейшие сита расширенного плей-офф (раунды 1/32 и 1/16 финала). Цена ошибки максимальна — победитель гарантирует себе как минимум участие в медальных матчах, проигравший — немедленно вылетает.
            * **Стадион и поле:** Легендарная открытая арена «Канзас-Сити Стэдиум» (*Arrowhead Stadium*, Канзас-Сити, Миссури). Великолепное натуральное травяное покрытие уложено специально под строгие стандарты ФИФА. Широкое поле предоставляет стратегическое преимущество командам, любящим растягивать оборонительные порядки соперника по флангам.
            * **Климатический фактор:** Июль в Миссури — это тяжелое физическое испытание. Ожидается высокая влажность воздуха и температура около **+28...31°C** на момент начала вечернего матча. Фактор выносливости и глубина скамейки запасных выйдут на первый план, так как обе сборные провели крайне энергозатратные поединки в 1/8 финала.
            * **Статус фаворита:** Аргентина котируется как безоговорочный фаворит у мировых букмекеров. Шансы на проход «Альбиселесте» в основное время оцениваются аналитиками примерно в **58–62%** (коэффициент в районе **1.65**).
            * **Исторический бэкграунд:** Аргентина — действующий чемпион мира (2022) и трехкратный обладатель титула. Для них выход в четвертьфинал — это обязательная часть программы. Швейцария не забиралась так высоко со времен домашнего ЧМ-1954. Для текущего поколения игроков это исторический шанс прыгнуть выше головы.

            ### 2. Табель о рангах и ценность ростеров
            * **Рейтинг FIFA:** Аргентина уверенно удерживает позиции в Топ-2 мирового рейтинга. Швейцария стабильно балансирует на стыке Топ-12–15, по праву являясь одной из самых крепких, системных и неуступчивых команд Европы.
            * **Класс исполнителей:** По суммарной трансферной стоимости состава Аргентина превосходит оппонента почти в три раза. Ростер аргентинцев перенасыщен суперзвездами мирового футбола (Энцо Фернандес, Лаутаро Мартинес, Алексис Мак Аллистер и, конечно, Лионель Месси). У Швейцарии главными игровыми активами выступают настоящая стена в воротах Грегор Кобель, а также Мануэль Аканджи, Гранит Джака и резкий атакующий полузащитник Рубен Варгас.

            ### 3. Текущая игровая форма команд
            * **🇦🇷 Аргентина:** Демонстрирует несгибаемый чемпионский характер, но при этом играет с огнем. В рамках 1/8 финала против Египта команда горела со счетом 0:2, но выдала невероятный эмоциональный камбэк в концовке встречи (3:2). Атака пребывает в огне, но в оборонительной линии появились явные бреши, которых не наблюдалось на победном мундиале в 2022 году.
            * **🇨🇭 Швейцария:** Настоящий «гранитный блок» текущего турнира. Они уверенно выиграли сложнейшую группу B (обогнав хозяев — Канаду) и хладнокровно прошли Колумбию в 1/8 финала через нулевую ничью и серию пенальти (4:3). Швейцарцы физически безупречны и ментально устойчивы к любому давлению.

            ### 4. Основная статистика турнирного пути на ЧМ-2026
            * **Аргентина:** 5 матчей — 4 победы в основное время, 1 поражение/ничья на групповой стадии. Разница забитых и пропущенных мячей: **11–5**. Команда забивает много (более 2 голов за матч в среднем), но стабильно пропускает от организованных контратак.
            * **Швейцария:** 5 матчей — 2 победы, 3 ничейных исхода (включая проход по пенальти). Разница мячей: **7–3**. Швейцарцы сыграли два сухих матча на турнире, их ключевой паттерн — вязкий футбол с минимумом свободного пространства для соперника.

            ### 5. Дополнительная статистика и микротренды
            * **Владение мячом:** Аргентина (**64%**) против Швейцарии (**47%**). Аргентинцы будут тотально владеть территорией и инициативой.
            * **Удары (всего / в створ):** Аргентина наносит в среднем **18.2** ударов (**9.1** в створ) за 90 минут. Швейцария отвечает скромными, но выверенными **11.4** ударами (**4.2** в створ).
            * **Стандарты (Угловые):** Аргентина подает в среднем **7.2** угловых за игру (следствие постоянных смещений Месси в центр и фланговых кроссов Молины/Акуньи). Швейцария имеет показатель в **4.1** корнера за матч.
            * **Дисциплинарная карта:** У Аргентины показатель предупреждений заметно выше (в среднем **2.1** за матч) из-за высокой эмоциональности и жесткого стиля Родриго Де Пауля и Кристиана Ромеро. Швейцария действует чище и позиционнее (**1.4** желтых карточек за игру).

            ### 6. История очных встреч (Head-to-Head)
            Самый памятный поединок сборных на Чемпионатах мира состоялся в 2014 году на стадии 1/8 финала. Тогда Аргентина дожала Швейцарию лишь на 118-й минуте овертайма благодаря голу Анхеля Ди Марии с ювелирного паса Месси (1:0). На ЧМ-1966 южноамериканцы победили 2:0. Исторически швейцарцы еще никогда не обыгрывали Аргентину в официальных матчах.

            ### 7. Тактико-стратегический рисунок и фишки
            * **Аргентина (4-3-3 или 4-4-2 ромб):** Лионель Скалони строит игру вокруг абсолютной свободы Лионеля Месси. Свободный художник Лео глубоко опускается за мячом, а Энцо Фернандес и Мак Аллистер насыщают полуфланги. Фишка — агрессивные врывания крайних защитников и огромный объем «черновой» работы Де Пауля, выжигающего центр. Сильная сторона — гениальность Месси в финальной трети. Главная проблема — уязвимость к быстрым вертикальным забросам за спину высокой линии обороны (что наглядно подсветил Египет).
            * **Швейцария (3-4-2-1 или 4-2-3-1):** Мурат Якин ставит на идеальную геометрию и синхронность движений. Аканджи цементирует оборону, Джака безупречно регулирует темп из глубины. Фишка — плотный средний блок, который выдавливает соперника во фланги, и мгновенный переход в атаку через реактивных Варгаса и Ндойе. Сильная сторона — мощная игра на «втором этаже» и стандарты.

            ### 8. Составы, травмы и кадровая ротация
            * **Аргентина:** Ожидается сыгранное сочетание: Эмилиано Мартинес; Молина, Ромеро, Отаменди (или Лисандро Мартинес), Тальяфико; Де Пауль, Энцо Фернандес, Мак Аллистер; Месси, Лаутаро Мартинес, Хулиан Альварес. Дисквалификаций после валидольной драмы с Египтом нет.
            * **Швейцария:** Боевой состав полностью готов: Кобель; Эльведи, Аканджи, Родригес; Видмер, Фройлер, Джака, Эбишер; Варгас, Ридер; Эмболо (или Амдуни). Голкипер Грегор Кобель поймал сумасшедший кураж после отраженного пенальти в игре с Колумбией и пребывает в безупречной психологической форме.

            ### 9. Индивидуальный перформанс лидеров
            * **Лионель Месси (Аргентина):** Снова в одиночку тащит сборную к триумфу. Спас матч с Египтом, забив гол и оформив важнейший ассист. Охотится за абсолютным рекордом по голам на мундиалях.
            * **Лаутаро Мартинес (Аргентина):** Ключевой наконечник атак, на счету которого уже **3** забитых мяча на текущем турнире.
            * **Гранит Джака (Швейцария):** Безоговорочный лидер по общему пробегу и точности передач (**89%**) в составе европейцев. Главный ментальный мотор команды.
            * **Грегор Кобель (Швейцария):** Заслуженный лучший игрок матча 1/8 финала. Пробить его прямым ударом с дистанции сейчас практически невозможно.

            ### 10. Мотивационный и ментальный вектор
            Для Аргентины это защита чемпионского титула и, скорее всего, лебединая песня Лионеля Месси на чемпионатах мира. Давление национальных медиа колоссальное, особенно после того, как команда едва не вылетела от египтян. Швейцария же играет абсолютно без груза ответственности. Они уже стали национальными героями дома, вернувшись в 1/4 финала впервые за 72 года. Этот статус «андердога без страха» делает европейцев смертельно опасными.

            ### 11. Тренерская дуэль
            * **Лионель Скалони (Аргентина):** Обладает непререкаемым авторитетом в раздевалке. Умеет вовремя признавать свои тактические просчеты (что блестяще доказал заменами в матче с Египтом). Всегда стабилен и спокоен.
            * **Мурат Якин (Швейцария):** Настоящий тактический хамелеон. Мастерски умеет подстраиваться под топ-сборные, полностью выключая их сильные стороны за счет жесткой персональной опеки (как это было на Евро-2024 против Италии).

            ### 12. Аналитический консенсус рынка
            Большинство ведущих футбольных экспертов сходятся во мнении, что Швейцария способна качественно «засушить» Аргентину в первом тайме. Ожидается, что «Альбиселесте» смогут взломать швейцарский сейф только ближе к 60-й минуте встречи. Букмекеры сознательно завышают коэффициент на тотал больше, ожидая максимально закрытый футбол в исполнении европейского коллектива.

            ### 13. Медийный фон и ключевые новости
            Главная новость — эмоциональное напряжение вокруг сборной Аргентины. Египетская федерация устроила громкий медийный скандал из-за судейства в 1/8 финала, что создало серьезное дополнительное давление на судейскую бригаду грядущего матча. Аргентинцам придется играть подчеркнуто чисто в отборе.

            ### 14. Судейский фактор
            Ожидается назначение строгого и авторитетного арбитра (вероятнее всего, из зоны УЕФА). На данном этапе турнира ФИФА жестко требует пресекать любую затяжку времени, что бьет по излюбленной тактике Швейцарии при равном счете. Количество мелких фолов со стороны швейцарцев на Месси на подступах к штрафной станет критическим фактором.
            ...
            * **xG / xA / xGOT (Ожидаемые события):**
            * Аргентина генерирует в среднем **2.15 xG** за матч. Модель показывает высочайшую конверсию моментов за счет индивидуального мастерства Месси и Альвареса. Швейцария имеет показатель **1.10 xG**. Они создают мало позиционных моментов, но выжимают максимум из стандартов.
            * По метрике ожидаемых ассистов (xA) у Аргентины Лионель Месси имеет космические **0.78 xA** за матч. У Швейцарии креатив равномерно размыт между Джакой и фланговыми навесами крайков (**0.22 xA**).
            * Параметр xGOT (ожидаемые голы с учетом створа) у Аргентины ощутимо выше, чем базовый xG (**2.35**), что наглядно говорит о феноменальной точности ударов южноамериканцев в углы ворот.
            * **Progressive Passes / Runs (Продвижение мяча):**
            * Аргентина продвигает мяч преимущественно через короткий и средний умный пас (Энцо Фернандес — абсолютный лидер турнира по передачам в финальную треть). Швейцария продвигает игровой снаряд более вертикально — длинными передачами Аканджи на реактивные фланги.
            * **Field Tilt (Наклон поля / Территориальное доминирование):**
            * У Аргентины этот показатель составляет внушительные **71%**. Они буквально запрут Швейцарию в ее штрафной площади на определенных отрезках матча.
            * **Pass Completion Rate (Точность передач):**
            * Аргентина демонстрирует гроссмейстерские **89.8%** точности паса. Швейцария удерживает планку на отметке **81.3%**.
            * **PPDA (Интенсивность прессинга):**
            * Аргентина включает сверхинтенсивный прессинг сразу после потери — PPDA равен **9.1**. Швейцария выбирает тактику низкого блока и пассивного ожидания ошибки соперника — PPDA **14.8**.
            * **Interceptions & Recoveries (Перехваты и подборы):**
            * Швейцария уверенно лидирует по числу перехватов в радиусе 20 метров от своих ворот (Мануэль Аканджи совершает в среднем **4.2** перехвата за игру).
            * **Комплексные модели оценки (VAEP & Heat Maps):**
            * У Аргентины Месси и Ди Мария (при выходе на поле) генерируют львиную долю атакующую ценности владения (**+0.12**). У Швейцарии самый высокий защитный индекс VAEP зафиксирован у Аканджи и Кобеля.
            * Тепловые карты (Heat Maps) наглядно показывают тотальное доминирование Аргентины перед штрафной соперника (зона дуги). У Швейцарии наблюдается плотное скопление игроков в собственной штрафной площади и две узкие полосы активности по бровкам поля.


            ## 3: РАСЧЕТ МАТЧА МЕТОДОМ ПУАССОНА

            Учитывая атакующую мощь Аргентины, пропущенные ими голы от Египта, а также железобетонный стиль Швейцарии в плей-офф, закладываем следующие параметры математического ожидания голов 
            Аргентина = 1.65
            Швейцария = 0.75
            ...
            | Сборная | 0 голов | 1 гол | 2 гола | 3 гола |
            | :--- | :--- | :--- | :--- | :--- |
            | **Аргентина** | 19.2% | 31.7% | 26.1% | 14.4% |
            | **Швейцария** | 47.2% | 35.4% | 13.3% | 3.3% |

            Итоговые вероятности исходов на основное время (90 минут):
            * **Победа Аргентины:** **56.4%**
            * **Ничейный исход:** **24.2%**
            * **Победа Швейцарии:** **19.4%**
            ...
            1. **Исход: Победа Аргентины (П1) в основное время**
            Рынок предлагает коэффициент **1.65** (что соответствует вероятности 60.6%). Наш расчет по Пуассону дает **56.4%**. Валуя на чистую победу Аргентины в основное время нет, коэффициент слегка занижен из-за громкого медийного имени фаворита.
            2. **Исход: Тотал Меньше 2.5 (ТМ 2.5)**
            Оценивается букмекерами в районе **1.75** (вероятность рынка — 57.1%). Сумма вероятностей низовых счетов (1:0, 2:0, 0:0, 1:1) по нашей модели составляет **61%**. **Здесь есть небольшое, но устойчивое VALUE.**
            3. **Исход: Швейцария с форой (+1)**
            Идет в линии за солидные **1.80**. Учитывая феноменальное умение швейцарцев сушить игру против топ-сборных и периодические просадки Аргентины в оборонительной фазе, это отличная рабочая валуйная позиция.


            ## 5: АНАЛИЗ ОБЩЕЙ ИНФОРМАЦИИ И РЕЗЮМЕ

            Матч будет развиваться по классическому кубковому сценарию «кошка против клубка». Аргентина полностью заберет мяч под свой контроль (Field Tilt 71%) и будет монотонно, позиционно искать бреши в плотных швейцарских редутах. 

            Швейцария после изнурительных 120 минут тяжелейшего матча с Колумбией явно сделает ставку на строгое удержание стартового счета и затягивание игры в овертайм, где Грегор Кобель снова может стать королем серии пенальти.

            Если Лионель Скалони сможет оперативно решить проблему быстрых вертикальных контратак соперника, а Родриго Де Пауль персонально перекроет кислород Граниту Джаке в центре поля, Аргентина додавит европейцев за счет класса. Однако легкой прогулки для Месси и компании точно не будет — Швейцария умеет терпеть и держать удар так, как никто другой на этом ЧМ.
            ...
            * **🎯 Основной выбор (Value): Тотал матча Меньше 2.5 голов за коэффициент 1.75.**
            Швейцария закроется на все замки с первых же минут, а Аргентина после валидольного матча с Египтом сыграет максимально строго и прагматично в защитной линии.
            * **🎯 Безопасный выбор (Для экспресса / ординара): Итоговый проход Аргентины в 1/2 финала за коэффициент 1.32.**
            Колоссальный класс Лионеля Месси и огромный опыт Эмилиано Мартинеса в кубковых стадиях на вылет должны сказать свое веское слово, даже если дело планомерно дойдет до экстра-таймов.
            * **🎯 Рискованный / Особый выбор: Ничья в основное время за коэффициент 3.60.**
            Дисциплинированная Швейцария вполне способна удержать тактически выверенные 0:0 или 1:1 по истечении 90 минут, полностью повторив вязкий сценарий их легендарного матча 2014 года.`
    
         }
    ],
    '1/2': [
        { id: 101, date: "Вторник, 14 июля", time: "22:00", stadium: "Даллас • Эй-Ти&Ти", team1Code: "fr", team1Text: "Франция", team2Code: "es", team2Text: "Испания", prob1: 34, probX: 28, prob2: 38, analysisText:
            `## 1: ОБЩАЯ АНАЛИТИКА И СИСТЕМНЫЙ РАЗБОР

            ### 1. Общая картина и антураж поединка
            * **Номер матча и статус:** Порядковый 101-й поединок грандиозного расширенного турнира, открывающий стадию 1/2 финала (первый полуфинал). Цена ошибки имеет абсолютное значение: победитель врывается в главный финал четырехлетия, проигравший — отправляется утешаться в матч за бронзовые медали.
            * **Стадион и поле:** Сверхсовременный «Эй-Ти-энд-Ти Стэдиум» (*AT&T Stadium*, Арлингтон, Техас). Уникальная закрытая арена, оснащенная раздвижной крышей и высокотехнологичной системой климат-контроля. Фактор изнуряющей техасской жары снаружи полностью нивелирован. Игровое покрытие — первоклассный натуральный газон, уложенный на специальной модульной основе по строжайшим гайдлайнам ФИФА.
            * **Статус фаворита:** Аналитики букмекерских контор закладывают минимальное математическое преимущество Испании исключительно за счет более вариативной и гибкой игры в атакующей фазе. При этом реальные шансы на проход в финал практически равны: **52% на 48%** в пользу «Красной фурии».
            * **Исторический бэкграунд:** Франция — признанный доминант мундиалей (триумфаторы 1998, 2018 годов и финалисты драматичного ЧМ-2022). Колоссальный кубковый опыт и менталитет победителей выступают главным козырем парней Дидье Дешама. Испания — чемпионы мира 2010 года, однако их текущий ростер — это действующие триумфаторы Евро-2024, имеющие бесценный свежий опыт побед в больших матчах самого высокого уровня.

            ### 2. Табель о рангах и ценность ростеров
            * **Рейтинг FIFA:** Оба коллектива монолитно закрепились в Топ-3 мирового рейтинга (Франция удерживает №2, Испания дышит в спину на №3).
            * **Класс исполнителей:** По совокупной рыночной стоимости и индивидуальным скиллам игроков (согласно продвинутым метрикам *Opta* и базам *EA Sports FC*) обе национальные сборные имеют практически идентичный средний рейтинг состава на уровне **86-88**. У «Трехцветных» чуть выше индивидуальный «потолок» за счет суперзвезды Килиана Мбаппе, тогда как у Испании наблюдается более сбалансированная, ровная и взаимозаменяемая по качеству обойма.

            ### 3. Текущая игровая форма команд
            * **🇪🇸 Испания:** Демонстрирует идеальный, чемпионский ход по турнирной дистанции. В их активе 5 уверенных побед при одной стратегической ничьей на групповой стадии (0:0 против Кабо-Верде). В сито плей-офф подопечные Луиса де ла Фуэнте без лишних вопросов переиграли Австрию (3:0), Португалию (1:0) и сломили Бельгию (2:1) в рамках 1/4 финала. Вся тактическая структура работает как швейцарские часы.
            * **🇫🇷 Франция:** Классический, прагматичный и подчеркнуто циничный стиль Дидье Дешама в действии. В атаке стало чуть меньше яркой искры, однако оборонительные порядки превратились в настоящий железобетон. В четвертьфинале французы уверенно и на классе переиграли крепкую сборную Марокко со счетом 2:0. Выход на пик физической формы идеально рассчитан тренерским штабом именно к решающим матчам полуфинала и финала.

            ### 4. Основная статистика турнирного пути на ЧМ-2026
            * **Испания:** Забито 11 голов, пропущено всего 2 (оба мяча влетели в сетку уже на стадии плей-офф — от Португалии и Бельгии). В среднем «Красная фурия» поражает ворота соперников **1.83** раза за матч.
            * **Франция:** Забито 10 голов, пропущено аналогично — всего 2 мяча за весь турнир. Средняя результативность составляет **1.66** гола за поединок. Общий процент побед на текущем мундиале — внушительные **83%**.

            ### 5. Дополнительная статистика и микротренды
            * **Владение мячом:** Испания традиционно забирает мяч под свой тотальный контроль (**59.5%**) против (**51.2%**) у Франции. Французы без малейших колебаний отдадут территорию и будут выманивать оппонента под контратаки.
            * **Удары (всего / в створ):** Испания наносит в среднем **15.4** ударов (**5.8** в створ) за 90 минут. Франция отвечает показателями в **13.1** ударов (**4.9** в створ).
            * **Стандарты (Угловые):** Испания подает ощутимо чаще (в среднем **6.2** за матч) из-за сверхактивной и широкой работы фланговых нападающих (Ямаль, Уильямс). Франция имеет скромные **4.8** корнера за матч, делая ставку на быстрые вертикальные прорывы по центру.
            * **Дисциплинарная карта:** Франция действует аккуратнее и чище в статичной фазе обороны (**1.2** желтых карточек за игру). У Испании этот показатель выше — **1.8** за матч, что связано с большим количеством тактических фолов для срыва чужих атак при агрессивном высоком прессинге.

            ### 6. История очных встреч (Head-to-Head)
            Последний громкий поединок официального уровня между командами состоялся в полуфинале Лиги Наций в июне 2025 года, подарив болельщикам невероятное шоу с победой Испании со счетом 5:4. До этого на Евро-2024 пиренейцы также оказались сильнее — 2:1. Исторический тренд последних лет четко подсвечивает минимальное, но системное тактическое преимущество «Фурии Рохи» над закрытым системным блоком Дешама.

            ### 7. Тактико-стратегический рисунок и фишки
            * **Испания (4-3-3 / 4-2-3-1):** Органичный гибрид классического позиционного владения и взрывных фланговых скоростей. У команды фиксируется стабильно высокий наклон поля. В центре задействуются умные игровые треугольники Родри — Ольмо — Фабиан Руис, которые идеально контролируют темп и направление атак.
            * **Франция (4-2-3-1 / 4-3-3):** Жесткий, низко-средний оборонительный блок. Команда Дешама сознательно выманивает соперника на свою половину поля, оголяя его тылы. Главная фишка — создание изоляций для Килиана Мбаппе на левом фланге атаки и интеллектуальное заполнение свободных зон Антуаном Гризманном и Майклом Олисе в полуфлангах.

            ### 8. Составы, травмы и кадровая ротация
            * **Испания:** Серьезных кадровых потерь или дисквалификаций нет. Из-за микротравмы Педри Луис де ла Фуэнте с первых минут выпустит Дани Ольмо в старте, что уже доведено до автоматизма в прошлых играх. Родри остается ключевым и незаменимым волнорезом в опорной зоне.
            * **Франция:** Майк Меньян займет свое законное место в створе ворот. Сыгранная пара центрбеков Конате — Упамекано абсолютно стабильна. Вся основная обойма полностью готова к бою, а Килиан Мбаппе подходит к важнейшему поединку без каких-либо физических ограничений.

            ### 9. Индивидуальный перформанс ключевых игроков
            * **Ламин Ямаль (Испания):** Абсолютный лидер текущего Чемпионата мира по числу созданных ключевых моментов (*Big Chances Created*) и успешному дриблингу на чужой трети поля.
            * **Килиан Мбаппе (Франция):** Главный теневой претендент на «Золотой мяч» в случае итогового триумфа сборной. На этом мундиале звездный форвард оформил уже **4** забитых мяча.

            ### 10. Мотивационный и ментальный вектор
            Максимально возможный уровень психологической ответственности. Это прямая битва за финал чемпионата мира. Учитывая природный прагматизм Дидье Дешама и колоссальную цену малейшей ошибки, первый забитый гол в матче заставит отличившуюся команду моментально сесть в глубокий оборонительный блок. Важность первого взятия ворот — абсолютная: до **90%** матчей этих сборных при счете 1:0 в их пользу неизменно заканчиваются победой.

            ### 11. Тренерская дуэль
            * **Луис де ла Фуэнте (Испания):** Триумфатор Евро-2024 и Лиги Наций. Досконально знает возможности молодежи, с которой выиграл абсолютно все титулы на юношеском уровне. Пользуется безграничным доверием руководства.
            * **Дидье Дешам (Франция):** Настоящая живая легенда (золото ЧМ-2018, серебро ЧМ-2022). Руководит национальной сборной целую вечность (с 2012 года). Для него это, возможно, последний шанс уйти абсолютным триумфатором. Дешам как никто другой в мире знает, как «сушить» и забирать такие матчи.

            ### 12. Аналитический консенсус рынка
            Подавляющее большинство экспертов сходится во мнении, что игра будет носить строго «шахматный», закрытый характер. 
            * **Коэффициенты на итоговый проход:** Испания — **1.85**, Франция — **1.98**.
            * **Котировки на основное время:** П1 — **2.60**, Х — **3.10**, П2 — **2.95**. Аналитики единодушно ожидают выраженный «низ» по забитым мячам.

            ### 13. Кадровый контекст и медиа-сплит
            Плавная смена поколений в стане Франции (в частности, окончательное отсутствие Оливье Жиру) переложила всю основную атакующую нагрузку на плечи Мбаппе. В испанской прессе вовсю празднуют тактическую зрелость новой генерации сборной. Политического давления на команды нет, обе сборные тренируются в условиях абсолютного комфорта и поддержки фанатов.

            ### 14. Судейский фактор
            На полуфинал назначен строгий и опытный рефери с жесткой планкой допущения борьбы. Средний тотал желтых карточек в плей-офф у судей такого калибра составляет **4.5**. Учитывая безумный накал встречи и контратакующий стиль Франции, испанцам придется регулярно фолить в тактических целях для предотвращения прорывов.
            ...
            * **xG / xA / xGOT (Ожидаемые события):**
            * Испания генерирует в среднем **1.94 xG** за матч. Пиренейцы создают моменты качественнее за счет монотонного позиционного давления. Франция имеет показатель **1.58 xG**.
            * По метрике ожидаемых ассистов (xA) Испания впереди — космические **1.45 xA** за игру (в основном благодаря гению Ямаля и Ольмо). У Франции этот параметр равен **1.10 xA** (основная угроза идет через кроссы и пасы под удар от Антуана Гризманна).
            * Параметр xGOT (ожидаемые голы с учетом точности и створа) у Франции демонстрирует оверперформанс — **1.72**, что напрямую связано с высочайшим качеством ударов Мбаппе и Барколя из сложных позиций. Испания бьет чаще, но показатели остаются ближе к номинальному xG.
            * **Progressive Passes / Runs (Продвижение мяча):**
            * Испания совершает в среднем **48** прогрессивных передач за 90 минут, взламывая соперника преимущественно через полуфланги. Франция делает всего **34** таких паса, однако полностью компенсирует это за счет рывков с мячом (*Progressive Runs* в исполнении Мбаппе и Дембеле на свободном пространстве) — **22** за игру.
            * **Key Passes (Ключевые передачи):**
            * Испанцы впереди по передачам под удар за матч — **11.8** против **9.2** у французов.
            * **Field Tilt (Наклон поля / Территориальное доминирование):**
            * У Испании этот показатель составляет солидные **62% на 38%**. Территориальное доминирование будет полностью за пиренейской сборной.
            * **Pass Completion Rate (Точность передач):**
            * Испания держит филигранные **89.5%** точности паса (в финальной зоне атаки — **84%**). Франция отвечает показателем в **86.1%** (в зоне атаки — **78%**).
            * **PPDA (Интенсивность прессинга):**
            * Испания включает сверхинтенсивное давление сразу после потери — PPDA равен **8.4**. Сопернику не дают поднять головы. Франция выбирает надежный средний блок, встречая оппонента ближе к центральному кругу — PPDA **12.6**.
            * **Interceptions & Recoveries (Перехваты и подборы):**
            * Франция уверенно лидирует по числу перехватов в собственной штрафной площади и радиусе 20 метров от нее — **38** успешных действий за игру. Испания же собирает львиную долю отскоков и подборов (Recoveries) прямо на чужой половине поля.
            * **Successful Pressures (Успешность давления):**
            * У Испании зафиксировано **32%** успешности прессинг-действий. У Франции этот параметр равен **26%**.
            * **Комплексные модели оценки (PV / VAEP):**
            * У Испании наибольшую ценность владения (*Possession Value*) стабильно генерирует связка Кукурелья – Уильямс на левом фланге и Родри в опорной зоне. У Франции аномально высокие индивидуальные показатели VAEP зафиксированы у Килиана Мбаппе — одно его изолированное действие (дриблинг или плотный удар) резко поднимает шансы на гол, даже если команда играет глубоким «вторым номером».


            ## 3: РАСЧЕТ МАТЧА МЕТОДОМ ПУАССОНА

            На основе атакующего потенциала (забитые голы и xG) и оборонительного рейтинга (допущенные голы и xGA) на текущем турнире, высчитываем среднюю ожидаемую результативность для каждой команды на нейтральном поле (с обязательной поправкой на важность стадии полуфинала, снижающую общую результативность на 15%)
            Испания = 1.22$$
            Франция = 1.08$$
            ...
            | :--- | :--- |
            | **Ничья 0 - 0** | 10.9% |
            | **Победа Испании 1 - 0** | 13.3% |
            | **Победа Франции 0 - 1** | 11.8% |
            | **Ничья 1 - 1** | 14.4% |
            | **Победа Испании 2 - 1** | 8.8% |
            | **Победа Франции 1 - 2** | 7.8% |
            | **Победа Испании 2 - 0** | 8.1% |

            Итог моделирования по Пуассону в основное время:
            * **Победа Испании:** **37.5%**
            * **Ничейный исход:** **28.1%**
            * **Победа Франции:** **34.4%**
            * **Тотал Меньше 2.5 мячей:** **60.5%**


            ##  4: ПОИСК VALUE В БУКМЕКЕРСКОЙ ЛИНИИ

            Сравниваем полученные математические расчеты с текущей линией букмекеров

            1. **Исход: Тотал Меньше 2.5 (ТМ 2.5)**
            Букмекер предлагает коэффициент **1.65** (вероятность рынка — 60.6%). Наш расчет дает 60.5%. Здесь линия стоит идеально ровно и честно, выраженного валуя нет.
            2. **Исход: Ничья (Х) в основное время**
            Букмекер дает в линию коэффициент **3.15** (что соответствует вероятности 31.7%). По нашей модели Пуассона вероятность составляет 28.1%. Валуйность полностью отсутствует.
            3. **Исход: Испания Индивидуальный Тотал Меньше (1.5) голов**
            Букмекеры дают отличный коэффициент **1.55** на то, что Испания не сможет забить более 1 гола в основное время. Учитывая монолитный оборонительный блок Франции и колоссальную важность матча, вероятность этого исхода по нашей модели превышает **73%** (сумма исходов 0:0, 0:1, 1:1, 1:2 и т.д.). **Это чистый, математически обоснованный VALUE.**


            ##  5: АНАЛИЗ ПОЛУЧЕННОЙ ИНФОРМАЦИИ И РЕЗЮМЕ

            Перед нами классическое, хрестоматийное столкновение футбольных стилей (*Proactive vs Reactive football*). Испания предсказуемо заберет мяч под свой контроль (Field Tilt > 60%), будет методично давить через фланговую активность Ямаля и обострения Ольмо, а также душить соперника контрпрессингом (PPDA < 9). Франция совершенно сознательно отдаст территорию, намертво закроет все свободные зоны для позиционных атак испанцев в финальной трети и будет жестоко карать соперника за высокую линию обороны молниеносными рывками Мбаппе на пространстве.

            Учитывая запредельную важность матча (полуфинал ЧМ), обе сборные полностью откажутся от неоправданного риска. Безбашенный результат Лиги Наций (5:4) точно не повторится — Дешам провел жесткую и детальную работу над ошибками. Матч будет подчеркнуто низовым, вязким, с огромным количеством мелких тактических фолов в центре поля.


            ## ЧАСТЬ 6: ЛУЧШИЕ СТАВКИ НА МАТЧ

            На основе глубокого математического и тактического анализа, лучшими выборами с точки зрения соотношения риска и Value являются:

            * **🎯 Основной выбор: Тотал матча Меньше 2.5 голов за коэффициент 1.65.**
            Железобетонный и максимально надежный вариант для полуфинала двух лучших и самых организованных оборон мира на текущем турнире.
            * **🎯 Валуйная ставка (VALUE): Индивидуальный Тотал Испании Меньше 1.5 голов за коэффициент 1.55.**
            Вскрыть оборонительный сейф Франции дважды в матче такого космического накала — задача для Испании практически невыполнимая с точки зрения теории вероятностей.
            * **🎯 Статистический выбор: Индивидуальный Тотал Желтых Карточек Испании Больше 1.5 за коэффициент 1.72.**
        ...
        { id: 102, date: "Среда, 15 июля", time: "22:00", stadium: "Аталанта • Мерседес-Бенц", team1Code: "gb-eng", team1Text: "Англия", team2Code: "ar", team2Text: "Аргентина", prob1: 31, probX: 28, prob2: 41, analysisText:
            `## 1. Общая аналитика

            ### 1. Общая картина
            - **Турнирный статус:** Матч 1/2 финала (поединок №102 на турнире). Победитель выходит в финал на «Нью-Йорк/Нью-Джерси-стейдиум», проигравший отправляется в утешительный матч за 3-е место.
            - **Стадион и поле:** «Атланта-стейдиум» (Mercedes-Benz Stadium), Атланта, Джорджия. Модифицированная закрытая арена с искусственным газоном последнего поколения и раздвижной крышей. Контролируемый внутренний климат (~22°C), внешняя влажность или жара не повлияют на качество игры.
            - **Кто фаворит:** Букмекеры и аналитические модели (Opta) отдают минимальное стартовое преимущество действующим чемпионам мира — Аргентине (**52%** на **48%** с учетом потенциального дополнительного времени).
            - **Кубковый опыт:** Аргентина — 3-кратные чемпионы мира, защищающие свой титул. Англия имеет лишь один домашний титул (1966), и для «Трех Львов» это всего 4-й полуфинал мировых первенств в истории.

            ### 2. Рейтинг команд и футболистов
            - **Рейтинг ФИФА:** Аргентина удерживает первую строчку (№1), Англия стабильно находится в пуле лидеров (№3–№4).
            - **Рейтинг игроков:** В составах обеих команд средний рейтинг исполнителей мирового класса. По метрикам рыночной стоимости ELO сборные входят в топ-5 самых дорогих составов мира. Джуд Беллингем (Англия), Лионель Месси и Лаутаро Мартинес (Аргентина) входят в наивысший эшелон индивидуальных рейтингов 2026 года.

            ### 3. Текущая форма на турнире
            - **Англия:** Заняли 1-е место в группе L (7 очков). В 1/32 финала прошли ДР Конго (2:1). В 1/16 финала устроили перестрелку с Мексикой (3:2), где получили красную карточку в начале второго тайма. В 1/4 финала проявили характер против Норвегии (2:1 д.в.), отыгравшись со счета 0:1 благодаря дублю Беллингема.
            - **Аргентина:** Выиграли группу J со стопроцентным результатом (9 очков). Плей-офф идет крайне результативно, но нервно: 1/32 финала — 3:2 против Кабо-Верде, 1/16 финала — 3:2 против Египта. В 1/4 финала дожали крепкую Швейцарию (3:1 д.в.), забив дважды на 112-й и 120-й минутах силами Макаллистера, Альвареса и Мартинеса.

            ### 4. Основная статистика на ЧМ-2026
            - **Англия:** Забито в плей-офф — 7 голов, пропущено — 4. Средняя результативность — 2.33 гола за игру. Команда стабильно забивает, но ни разу на стадии на вылет не сыграла «на ноль».
            - **Аргентина:** Забито в плей-офф — 9 голов (лучший показатель среди полуфиналистов), пропущено — 5. Альбиселесте стабильно забивают строго по 3 гола в основное или дополнительное время в каждом раунде плей-офф.

            ### 5. Дополнительная статистика (тренды турнира)
            - **Угловые:** Англия активно использует фланги и стандарты (в среднем 6.2 за матч). Аргентина предпочитает короткий розыгрыш через центр (в среднем 4.8 угловых).
            - **Контроль мяча:** Аргентина — **59.4%**, Англия — **55.1%**. Обе команды любят владеть мячом, но южноамериканцы действуют более стерильно в центре поля.
            - **Дисциплина (карточки):** У Англии есть проблемы с дисциплиной (прямая КК против Мексики, 5 ЖК против Норвегии). Аргентина действует агрессивно в контрпрессинге (3 ЖК против Швейцарии).
            - **Удары:** Аргентина бьет чаще из пределов штрафной (14.2 ударов за матч), Англия делает ставку на дальние удары и завершение навесов Кейном или Беллингемом (11.8 ударов).

            ### 6. Очные встречи
            - Историческое противостояние уровня «класико». Последняя официальная встреча на ЧМ была в 2002 году (победа Англии 1:0). В товарищеских встречах последних лет — паритет. Стилистически это вечное противостояние прагматичной структуры Европы и техничной вертикальности Южной Америки.

            ### 7. Тактика и стиль игры
            - **Англия (гибридные 4-3-3 / 3-4-2-1):** Критически зависимы от рывков Сака и креатива Беллингема, который исполняет роль свободного художника.
            - *Проблема:* Медленный выход из-под интенсивного давления и уязвимость фланговых защитников.
            - **Аргентина (системные 4-3-3 или 4-4-2 «ромб»):** Лионель Скалони выстраивает идеальный баланс вокруг Месси. Главная фишка — сверхинтенсивные перегрузки в полуфлангах (Макаллистер — Де Пауль) и взрывная скорость Альвареса.
            - *Проблема:* Потеря концентрации в концовках матчей при переходе в низкий оборонительный блок (пропустили по 2 гола от Кабо-Верде и Египта).

            ### 8. Составы, травмы и ротация
            - **Англия:** Вернулся в строй отбывший дисквалификацию защитник. Гарри Кейн выполняет огромный объем черновой работы, стягивая центрбеков. Мощная скамейка Англии (Палмер, Фоден, Уоткинс) позволяет радикально менять темп во втором тайме.
            - **Аргентина:** После изнурительных 120 минут со Швейцарией Скалони проведет точечную ротацию в полузащите. Лаутаро Мартинес забил со скамейки и претендует на старт, хотя связка Хулиана Альвареса с Месси предпочтительнее для высокого прессинга. Серьезных травм нет.

            ### 9. Статистика отдельных игроков
            - **Джуд Беллингем (Англия):** Главный мотор команды. Его дубль вытащил Англию в полуфинал. Главный претендент на Золотой Мяч в случае триумфа англичан.
            - **Лаутаро Мартинес и Хулиан Альварес (Аргентина):** На двоих разрывают сетку ворот соперников в овертаймах плей-офф.
            - **Лионель Месси (Аргентина):** Проводит гроссмейстерский турнир, выполняя роль глубинного плеймейкера и стягивая на себя по 2-3 игрока.

            ### 10. Настрой команд и важность матча
            - Для Англии — это шанс избавиться от проклятия «почти чемпионов». Для Аргентины — подтверждение статуса мирового гегемона и потенциально последний аккорд Месси на мундиалях. Напряжение максимальное, цена ошибки — путевка в финал.

            ### 11. Тренерский фактор
            - **Тренерский штаб Англии:** Система Англии прагматична, строго ориентирована на результат в кубковых стадиях. Опыт больших матчей колоссален, но команду часто критикуют за пассивность при счете 1:0.
            - **Лионель Скалони:** Выиграл все возможные трофеи со сборной, с командой уже 8 лет. Умеет идеально адаптировать тактическую схему под конкретного соперника прямо по ходу матча. Ментальный лидер раздевалки.

            ### 12. Мнения аналитиков и букмекеров
            Большинство экспертов сходится во мнении, что матч затянется. Котировки на основное время
            - **Победа Англии:** $3.10$
            - **Ничья:** $3.20$
            - **Победа Аргентины:** $2.45$
            - **Проход в финал:** Англия — $2.10$, Аргентина — $1.75$.


            ## 2. Футбольные метрики

            ### 1. Атакующие метрики (ожидаемые события)
            - **xG (Expected Goals):** Аргентина — $2.15$ за матч (создают много явных моментов за счет тонких пасов вразрез). Англия — $1.85$ (высокий xG за счет стандартов и плотности ударов Кейна).
            - **xA (Expected Assists):** У Аргентины явный перекос на Месси и Ди Марию/его сменщиков (высокое качество передач под удар). У Англии угроза распределена между флангами (Сака, Триппьер/Шоу) и Беллингемом.
            - **xGOT (Expected Goals on Target):** У Аргентины выше конверсия — нападающие бьют прицельно (xGOT превышает xG на $12\\%$). Англия бьёт чаще, но прямолинейнее.

            ### 2. Метрики продвижения мяча и паса
            - **Progressive Passes / Runs:** Англия лидирует по продвижениям через рывки (Деклан Райс, Беллингем тащат мяч на дриблинге). Аргентина продвигает мяч исключительно через умные передачи Макаллистера и Энцо Фернандеса.
            - **Key Passes:** Аргентина делает в среднем на 3 ключевые передачи в финальную треть больше.
            - **Field Tilt (Наклон поля):** Аргентина — $61\\%$ времени зажимает соперника. Англия — $54\\%$, они готовы осознанно отдавать территорию, уповая на быстрые контратаки.
            - **Pass Completion Rate:** Аргентина — **88.5%** (короткий пас), Англия — **86%** (более вертикальный футбол).

            ### 3. Защитные и прессинг-метрики
            - **PPDA:** Аргентина — $8.4$ (высокий, прессинг сразу после потери). Англия — $11.2$ (средний блок, прессингуют избирательно, экономя силы Гарри Кейна).
            - **Interceptions & Recoveries:** Англия за счет физики Стоунза и Райса хороша в перехватах при навесах. Аргентина (Ромеро, Лисандро Мартинес) выжигает землю внизу при приеме мяча соперником спиной к воротам.
            - **Successful Pressures:** У Аргентины эффективность прессинга выше ($34\\%$ удачных действий против $28\\%$ у Англии).

            ### 4. Комплексные модели (PV / VAEP / Heat Maps)
            - **PV / VAEP:** У Аргентины наибольший вклад в обострение генерирует правый полуфланг. У Англии — левый инсайд (зона Беллингема).
            - **Тепловые карты (Heat Maps):** Аргентина заполнит всю зону перед штрафной соперника дугой. Англия будет иметь «горячие точки» на флангах и в районе вратарской (борьба на втором этаже).


            ## 3. Расчет матча методом Пуассона

            На основе забитых/пропущенных мячей и метрик xG на турнире:
            - Аргентина: Забивает 2.20 гола за игру, пропускает 1.20.
            - Англия: Забивает 1.80 гола за игру, пропускает 1.00.
            - Базовый средний показатель забитых голов для топ-команд: = 1.6$.
            - Ожидаемые голы Аргентины : $1.54$
            - Ожидаемые голы Англии : $1.26$
            ...
            - **Победа Аргентины в основное время:** $41.2\\%$
            - **Ничья в основное время:** $27.6\\%$
            - **Победа Англии в основное время:** $31.2\\%$


            ## 4. Поиск в линии VALUE (Честной ставки)

            Линия букмекеров: П1 — 2.45 ($40.8\\%$), Х — 3.20 ($31.2\\%$), П2 — 3.10 ($32.2\\%$).
            Сравниваем с нашей моделью Пуассона:
            - Букмекер заметно переоценивает вероятность ничьей в основное время ($31.2\\%$ в линии против $27.6\\%$ по расчетам).
            - Букмекеры закладывают осторожный футбол, но обе команды на этом ЧМ много забивают и стабильно пропускают в плей-офф (все матчи обеих команд на вылет пробили ТБ 2.5 либо зафиксировали «Обе забьют»).
            - Честный коэффициент на «Обе забьют — Да» по Пуассону и xG-модели должен быть в районе **1.72**. Букмекеры из-за статуса полуфинала дают на этот исход около **1.95 – 2.05**. Здесь кроется чистый Value.


            ## 5. Анализ полученной информации

            Матч имеет колоссальное значение. Аргентина выглядит цельнее по метрикам Field Tilt и xG, однако их оборона регулярно дает сбои под занавес встреч. Англия на этом турнире — «короли выживания» (камбэки, голы в овертаймах). Поскольку обе сборные имеют потрясающую атакующую мощь (Беллингем/Кейн против Месси/Мартинеса) и при этом уязвимые защитные порядки, которые не удержали сухими ворота ни в одном матче плей-офф, игра не будет закрытой на 100%. Аргентина заберет мяч, Англия будет жалить контратаками и стандартами.


            ## 6. Лучшие ставки на матч

            **1. Основной выбор (Инвестиция): Обе забьют — Да (Коэффициент  2.00$)**
            - **Обоснование:** Главный устойчивый тренд обеих сборных в плей-офф ЧМ-2026. Атака на данном этапе турнира явно превосходит оборонительные порядки у обеих команд.

            **2. Валуй-выбор (Value Bet): Тотал больше 2.0 голов (Коэффициент 1.65$)**
            - **Обоснование:** Идеальный вариант для подстраховки с полным возвратом на случай прагматичного счета 2:0 или ничьей 1:1. Вероятность сухой игры минимальна.

            **3. Проход в финал: Проход Аргентины (Коэффициент  1.75$)**
            - **Обоснование:** За счет тактической гибкости Скалони, гения Месси и умения Альбиселесте правильно распределять силы на дистанции 120 минут (что они наглядно доказали в четвертьфинале со Швейцарией).`
    
         }
    ],
    '3-е место': [
        { id: 103, date: "Воскресенье, 19 июля", time: "00:00", stadium: "Майами • Хард Рок", team1Code: "fr", team1Text: "Франция", team2Code: "gb-eng", team2Text: "Англия", prob1: 46, probX: 22, prob2: 32, analysisText:
            `## 1. Общая аналитика

            Обе команды обидно оступились в полуфиналах (Франция уступила Испании со счетом 0:2, а Англия пропустила на 92-й минуте от Аргентины — 1:2) и теперь оспорят бронзовые медали турнира.

            ### 1. Общая картина
            - **Турнирный статус:** Матч за 3-е место (утешительный финал). Для обеих сборных это 8-й поединок на турнире.  
            - **Стадион и условия:** «Майами-стейдиум» (Флорида). Ожидается высокая влажность и изнуряющая температура воздуха около **30°C**. Прошлые матчи Англии в Майами (в частности, против Норвегии) показали, что духота и климатический фактор критически сказываются на физических кондициях футболистов во втором тайме.
            - **Кто фаворит:** Франция идет небольшим фаворитом у букмекеров (вероятность победы «Трехцветных» в основное время оценивается примерно в **53%** против **24%** у Англии, на ничью аналитики отводят около **23%**).
            - **Опыт на ЧМ:** Франция — двукратный чемпион мира (последний раз в 2018 году) и серебряный призер ЧМ-2022. Англия выигрывала золотые медали лишь однажды в своей истории (1966 год), а их последний матч за 3-е место состоялся в 2018 году и завершился поражением от Бельгии со счетом 0:2.

            ### 2. Рейтинги команд и игроков
            - **Рейтинг ФИФА:** Франция стабильно удерживает позицию в топ-3 мирового чарта. Англия дышит им в спину, располагаясь в топ-5.
            - **Рейтинг футболистов:** Килиан Мбаппе и Джуд Беллингем — самые дорогие, звездные и медийные активы этой встречи, оцениваемые на трансферном рынке свыше €180 млн каждый.  

            ### 3. Текущая форма на турнире  
            - **Франция:** Уверенно шли «катком» до самого полуфинала (5 побед в основное время, включая разгром Швеции 3:0 и прагматичные 2:0 с Марокко). Неожиданная осечка произошла только против тактически безупречной Испании (0:2).  
            - **Англия:** Путь «Трех Львов» получился куда более тернистым и изматывающим. Сложная победа над Мексикой (3:2), тяжелейший овертайм с неуступчивой Норвегией (2:1) и упущенная на последних секундах ничья с Аргентиной. Физически англичане выглядят значительно более истощенными.  

            ### 4. Основная статистика на ЧМ-2026
            - **Франция:** Забито 16 голов, пропущено 3. Огромный атакующий потенциал (96 ударов по воротам, 50 в створ — лучшие показатели на текущем турнире).  
            - **Англия:** Забито 14 голов, пропущено 9. Защитные редуты Томаса Тухеля регулярно дают сбои — родоначальники футбола пропускали практически в каждом матче плей-офф.  

            ### 5. Дополнительная статистика (тренды турнира)
            - **Контроль мяча:** Франция в среднем удерживает за собой **56–58%** игрового времени. Англия при Тухеле стала действовать в более вертикальном и прагматичном стиле (около **52%** владения).
            - **Удары по воротам:** Франция существенно превосходит Англию по частоте и точности дальних ударов (активно бьют Дембеле, Мбаппе, Баркола).
            - **Дисциплина (карточки):** Обе сборные играют аккуратно и чисто. У Франции на турнире нет красных карточек, они используют аккуратный позиционный прессинг.

            ### 6. Очные встречи
            - Последний официальный матч команд на ЧМ-2022 в Катаре (стадия 1/4 финала) завершился победой Франции со счетом 2:1 (тогда Гарри Кейн смазал решающий пенальти в концовке). Исторический перевес в официальных играх XXI века остается на стороне французов.

            ### 7. Тактика и стиль игры
            - **Франция (4-2-3-1 / 4-3-3):** Дидье Дешам традиционно ставит на реактивные фланги и мощный баланс в центре поля (связка Чуамени — Рабьо). Главная фишка — создание изоляций для Мбаппе на левом фланге и резкие включения Олисе или Баркола с противоположного края.
            - **Англия (4-2-3-1):** Томас Тухель пытается привить команде тактическую гибкость, но часто публично критикует игроков за потерю концентрации и излишнюю «пассивность» после забитых мячей (что ярко проявилось против Аргентины). Склонны по ходу встречи перестраиваться на схему с 5 защитниками при удержании счета.

            ### 8. Составы, травмы и ротация
            - **Франция:** Ведущий защитник Вильям Салиба получил болезненное повреждение в полуфинале (был заменен на Максанса Лакруа уже на 29-й минуте) и вряд ли появится на поле с первых минут. В остальном обойма французов цела. Весьма вероятен выход Оливье Жиру или Маркуса Тюрама в старте, чтобы предоставить заслуженный отдых Баркола.  
            - **Англия:** Рис Джеймс только восстановился от травмы бедра и отыграл энергозатратную 81 минуту против Аргентины. Учитывая фактор ротации для матча за бронзу, Тухель наверняка задействует со скамейки свежих Олли Уоткинса, Кобби Мейну или Коула Палмера.  

            ### 9. Статистика ключевых игроков
            - **Килиан Мбаппе (Франция):** Забил уже 8 голов на текущем турнире. Ведет прямую борьбу с Лионелем Месси за Золотую бутсу ЧМ-2026. Мотивация форварда отличиться в этой встрече будет запредельной.  
            - **Джуд Беллингем (Англия):** Настоящий лидер сборной (6 голов, делит звание лучшего бомбардира команды с Кейном). Находится в шорт-листе главных соискателей Золотого мяча.  

            ### 10. Настрой команд и мотивация
            - **Традиция «бронзы»:** Команды исторически подходят к утешительному финалу по-разному. Франция, бравшая золото и серебро на прошлых мундиалях, может сыграть более расслабленно, дав время резервистам. Для Англии и Тухеля «бронза» — это реальный способ спасти репутацию после шквала критики на родине. При этом «синдром опустошения» после вылета из 1/2 финала бьет по обоим коллективам, что традиционно приводит к открытому, сверхрезультативному футболу без оглядки на оборону.

            ### 11. Тренерский фактор
            - **Дидье Дешам:** Бессменно возглавляет сборную с 2012 года. Брал золото ЧМ-2018. Спокоен, его контракт стабилен, но этот турнир вполне может стать его прощальным аккордом у руля национальной команды.
            - **Томас Тухель:** Пришел с конкретной максималистской целью — привезти кубок в Англию. Вылет в полуфинале стал болезненным ударом по амбициям немца. Ему критически важно завершить турнир на мажорной ноте.

            ### 12. Мнения аналитиков и букмекеров
            - Большинство экспертов сходится во мнении, что матч за 3-е место станет настоящим «фестивалем футбола». Команды снимут тяжелейшее тактическое напряжение, а значит, нас ожидает яркий «верх» по голам. Букмекеры активно фиксируют прогруз линии на исход «Обе забьют — Да».  

            ### 13. Арбитр матча
            - Официальное судейское назначение от ФИФА ожидается ближе к игре. Судейский комитет обычно доверяет утешительный финал топ-арбитрам, которые отлично проявили себя на ранних стадиях, но не могут работать на главном финале из-за географических или конфедеративных ограничений.


            ## 2. Анализ по футбольным метрикам

            Усредненные тактические параметры команд на дистанции ЧМ-2026 

            *   **xG (Ожидаемые голы):**
                *   **Франция:** **1.94** | **Англия:** **1.58**
                *   *Интерпретация:* Франция генерирует более качественные и подготовленные моменты. У Англии прослеживается явный перекос в сторону индивидуального мастерства Кейна и Беллингема.
            *   **xGA (Ожидаемые пропущенные):**
                *   **Франция:** **0.82** | **Англия:** **1.24**
                *   *Интерпретация:* Оборона Франции до полуфинального матча с Испанией функционировала на порядок надежнее и организованнее.
            *   **Field Tilt (Наклон поля):**
                *   **Франция:** **59%** | **Англия:** **51%**
                *   *Интерпретация:* Французская сборная существенно дольше держит мяч и проводит позиционные атаки в финальной трети поля соперника.
            *   **PPDA (Интенсивность прессинга):**
                *   **Франция:** **9.4** | **Англия:** **11.2**
                *   *Интерпретация:* Франция вступает в активный отбор заметно быстрее сразу после потери мяча. Прессинг Англии носит более пассивный, зонный характер.
            *   **Progressive Passes (Передачи вперед за игру):**
                *   **Франция:** **44.2** | **Англия:** **38.5**
                *   *Интерпретация:* У французов качественнее и быстрее выстроено продвижение мяча через центральную ось за счет работы Чуамени и Гризманна.


            ## 3. Расчет матча методом Пуассона

            Для расчета возьмем базовую результативность команд на ЧМ-2026 и их оборонительные показатели (с поправкой на нейтральное поле в Майами)
            - Средний забитый xG Франции: $1.90$
            - Средний пропущенный xG Англии: $1.25$
            - Средний забитый xG Англии: $1.55$
            - Средний пропущенный xG Франции: $0.85$

            Учитывая статус утешительного финала (где общая результативность исторически возрастает на **20–25%** из-за снижения оборонительной дисциплины), скорректируем ожидаемые голы сторон
            - **Индивидуальный тотал Франции**  2.18
            - **Индивидуальный тотал Англии**  1.78

            Применяя формулу распределения вероятностей Пуассона


            - **Франция забьет:** 0 голов — **11.3%** | 1 гол — **24.6%** | 2 гола — **26.8%** | 3 гола — **19.5%**
            - **Англия забьет:** 0 голов — **16.8%** | 1 гол — **30.0%** | 2 гола — **26.7%** | 3 гола — **15.8%**  

            Самые вероятные исходы встречи в основное время:
            - **Ничья 1:1** —  7.4\\%
            - **Победа Франции 2:1** —  8.0\\% *(наиболее вероятный точный счет)*
            - **Ничья 2:2** —  7.1\\%
            - **Победа Англии 1:2** —  6.6\\%

            Интегральные вероятности исходов в основное время:
            - **Победа Франции:** **46.5%**
            - **Ничья:** **21.8%**
            - **Победа Англии:** **31.7%**
            - **Прогноз на Тотал Больше 2.5 голов:**  64.5\\%


            ## 4. Поиск VALUE (Честной ставки)

            Букмекерские котировки на исход (1X2)
            - **Победа Франции:** Коэффициент **2.10** (букмекерская вероятность 47\\%$)
            - **Ничья:** Коэффициент **3.50** (букмекерская вероятность  25\\%$)
            - **Победа Англии:** Коэффициент **3.30** (букмекерская вероятность  28\\%$)

            Сравнение расчетной математической модели с линией букмекеров  
            - **Победа Франции за 2.10:** Наша вероятность **46.5%** дает честный коэффициент $1 / 0.465 = 2.15$. Валуйность отсутствует.  
            - **Победа Англии за 3.30:** Наша вероятность **31.7%** дает честный коэффициент $1 / 0.317 = 3.15$. Присутствует небольшое математическое преимущество (Value). Букмекеры слегка недооценивают Англию на фоне их невзрачной игры в полуфинале.  
            - **Тотал Больше 2.5 за 1.85:** Наша модель дает вероятность прохода ТБ 2.5 в районе **64.5%** (честный кэф **1.55**). Это явный и сильный валуй. Матчи за 3-е место исторически бьют рекорды результативности.


            ## 5. Анализ общей информации

            Матч пройдет в тяжелейших климатических условиях Майами. Франция обладает более сбалансированным и классным составом, а также сумасшедшей мотивацией Килиана Мбаппе забрать Золотую бутсу турнира. Однако потеря ключевого центрального защитника Вильяма Салиба может критически ослабить их оборонительный потенциал.

            Англия Тухеля выйдет на поле под серьезным давлением британской прессы. Для них бронзовые медали — это реальная возможность подсластить горькую пилюлю вылета, в то время как французы могут отнестись к игре скорее как к выставочной. С учетом скорректированного распределения Пуассона и мотивационных факторов, игра гарантированно пойдет на встречных курсах.


            ## 6. Лучшие ставки на матч

            **1. Основной выбор: Обе забьют — Да + Тотал Больше 2.5 (Коэффициент  2.05$)**
            - **Обоснование:** Исторический тренд матчей за 3-е место на Чемпионатах мира гарантирует нам открытую игру без жестких оборонительных редутов. Обе команды обладают запредельным атакующим потенциалом.

            **2. Валуй-ординар: Фора Англии (0) в основное время (Коэффициент  2.45$)**
            - **Обоснование:** Если Дидье Дешам решится на глубокую ротацию состава, более сыгранная и сверхмотивированная банда Тухеля за счет характера Беллингема и Кейна способна вырвать итоговую бронзу.

            **3. Ставка на игрока: Килиан Мбаппе забьет гол (Коэффициент  2.15$)**
            - **Обоснование:** Французский форвард будет исполнять абсолютно все стандарты и пенальти своей команды, чтобы опередить Месси в бомбардирской гонке за Золотую бутсу ЧМ-2026.`
    
         }
    ],
    'Финал': [
        { id: 104, date: "Воскресенье, 19 июля", time: "22:00", stadium: "Нью-Джерси • ФИНАЛ ЧМ-2026", team1Code: "es", team1Text: "Испания", team2Code: "ar", team2Text: "Аргентина", prob1: 44, probX: 31, prob2: 25, isGrandFinal: true, analysisText:
            `Историческое столкновение эпох на «МетЛайф Стэдиум». Действующие чемпионы мира и обладатели Кубка Америки защищают корону в битве против самой идеальной и доминирующей европейской машины последних лет.

        ## 1) Общая аналитика

        ## 1. Общая картина
        - **Статус матча:** Финал чемпионата мира (64-й матч турнира). Главная игра четырехлетия.
        - **Поле и стадион:** «МетЛайф Стэдиум» (Ист-Ратерфорд, Нью-Джерси, США). Вместимость — 82 500 зрителей. Газон — современный гибридный искусственный пласт поверх бетонного основания. Это делает отскок более быстрым и увеличивает травмоопасность по сравнению с классическим мягким грунтом.
        - **Климат:** Июльская духота в Нью-Джерси. Влажность часто превышает **70%**, температура воздуха на момент начала игры (15:00) составит около **+26°C…+30°C**. Тяжелейшие климатические условия, которые ударят по интенсивности прессинга во втором тайме.
        - **Кто фаворит:** Букмекеры отдают небольшое предпочтение Испании (коэффициент на завоевание трофея **1.61** против **2.25** на Аргентину).
        - **Опыт в финалах:** Аргентина — действующий чемпион мира (2022). Команда обладает запредельным опытом больших побед. Испания возвращается в финал мундиаля впервые с золотого 2010 года.

        ## 2. Рейтинги команд и футболистов
        - **Рейтинг ФИФА:** Аргентина возглавляет мировую табель о рангах, Испания идет следом в топ-3.
        - **Класс игроков:** По трансферной стоимости и глубине состава испанцы (Родри, Ламин Ямаль, Педри) имеют символический перевес. У Аргентины пиковые показатели удерживают Лео Месси (демонстрирующий лучший перформанс на турнире), Лаутаро Мартинес и Энцо Фернандес.

        ## 3. Текущая форма на ЧМ-2026
        - **Испания :** Пребывает в феноменальной форме. Команда Луиса де ла Фуэнте не проигрывает в официальных встречах 37 матчей подряд. В плей-офф уверенно прошли Португалию (**1:0**), Бельгию (**2:1**) и Францию (**2:0**). Все победы добыты в основное время.
        - **Аргентина :** Действует в прагматичном стиле «хищника». Путь в плей-офф выдался изматывающим: одолели Кабо-Верде в овертайме (**3:2**), Египет (**3:2**), Швейцарию снова в овертайме (**3:1**) и Англию в полуфинале (**2:1**). Накопленная усталость у южноамериканцев существенно выше.

        ## 4. Основная статистика (на турнире)
        - **Испания:** Забито 13 голов в 7 матчах (в среднем **1.85** за игру). Пропущен всего 1 гол (**0.14** за игру) — абсолютный рекорд и лучшая оборона ЧМ.
        - **Аргентина:** Забито 17 голов в 6 матчах (в среднем **2.83** за игру) — самая результативная атака турнира. Пропущено 8 мячей (в среднем **1.33** за игру).

        ## 5. Дополнительная статистика (Тренды)
        - **Угловые:** Испания активно использует ширину поля (в среднем **6.4** за матч). Аргентина подает реже — **5.1** за игру.
        - **Контроль мяча:** Испания доминирует по владению (**59%**), у Аргентины этот показатель составляет **54%**.
        - **Удары и точность:** Испания наносит **14.8 ударов** за матч (5.9 в створ). Аргентина бьет реже — **12.3 ударов**, но имеет феноменальную конверсию в створ (6.1).
        - **Дисциплина:** Аргентина действует значительно агрессивнее и охотнее использует тактический фол (в среднем **2.4 ЖК** за матч против **1.2 ЖК** у Испании).

        ## 6. Очные встречи
        Последний громкий товарищеский матч в 2018 году завершился разгромом Аргентины со счетом 6:1. Исторический баланс команд абсолютно равен, но текущие составы и ментальное состояние сборных не имеют ничего общего с событиями восьмилетней давности.

        ## 7. Тактика, стиль и фишки
        - **Испания (4-2-3-1 / 4-3-3):** «Вертикальная ярость». Де ла Фуэнте отказался от стерильной «тики-таки». Испанцы продвигают мяч максимально быстро через фланги. Родри гениально регулирует темп, а связки на краях разрывают полуфланги соперника.
        - **Аргентина (4-4-2 ромб / 4-3-3):** Гибкий гибрид. Команда Лионеля Скалони готова осознанно отдавать территорию, выманивать оппонента в прессинг и наказывать за счет проникающих передач Месси на ход реактивному Лаутаро.

        ## 8. Составы и кадровые проблемы
        - **Испания:** Все ключевые исполнители в строю. Марк Кукурелья отбыл дисквалификацию и закроет левый фланг. В центре обороны сыграет надежная пара Ляпорт — Кубарси.
        - **Аргентина:** Дисквалификаций нет. Лисандро Мартинес и Кристиан Ромеро начнут в старте. Родриго де Поль готов выполнять гигантский объем черновой работы в опорной зоне, страхуя зоны Месси.

        ## 9. Статистика отдельных лидеров
        - **Лионель Месси (Аргентина):** 8 голов и 1 ассист. Главный претендент на «Золотой мяч» ЧМ и звание MVP турнира.
        - **Ламин Ямаль (Испания):** Совершил **22 ключевых действия** (дриблинг и пасы под удар), уступая на турнире только Месси (24).
        - **Родри (Испания):** Лидер ЧМ по числу точных передач (**705**). Мозг и хребет сборной Испании.

        ## 10. Настрой и мотивация
        - **Испания:** Желание вернуть корону мирового футбола поколению «золотой молодежи» (Ямаль, Педри, Кубарси) под предводительством Родри.
        - **Аргентина:** Потенциально «последний танец» Месси на ЧМ. Мотивация защитить титул запредельная, аргентинцы ментально устойчивее в стрессовых сценариях плей-офф.

        ## 11. Тренерский фактор
        Луис де ла Фуэнте (Испания) выиграл Евро-2024 и построил идеальную синергию молодости и опыта. Лионель Скалони (Аргентина) — действующий чемпион мира, гений тактической гибкости и нейтрализации сильных сторон абсолютно любого соперника.

        ## 12. Мнение аналитиков и букмекеров
        Аналитики сходятся во мнении, что Испания заберет мяч, а Аргентина будет выстраивать оборонительные капканы в расчете на гений Месси. Букмекеры выставили практически равную линию на 90 минут с минимальным креном в пользу «Красной Фурии».

        ## 13. Ключевые внешние факторы
        - **Усталость:** Аргентина отыграла на 60 минут больше в плей-офф, у них было два изнурительных овертайма.
        - **Покрытие:** Сухой и быстрый газон «МетЛайф» ощутимо благоволит техничному и быстрому пасу испанцев.

        ## 14. Анализ арбитра
        Ожидается высочайший порог фиксации фолов в начале игры. Однако жесткие стыки аргентинцев в центре поля при сдерживании контратак быстро вынудят судью расчехлить желтые карточки.

        ## 2) Футбольные метрики

        ### 📊 xG (Ожидаемые голы) за игру
        - **Испания :** 1.72
        - **Аргентина :** 2.18
        - *Вывод:* Аргентина создает больше «чистых» моментов с игры, у Испании угроза более распределена по всему фронту атаки.

        ### 🎯 xA (Ожидаемые ассисты) за игру
        - **Испания :** 1.45
        - **Аргентина :** 1.80
        - *Вывод:* Зависимость Аргентины от креатива Месси (xA 0.72 лично) значительно выше, чем у Испании, где угроза идет в равной степени с обоих флангов.

        ### 📐 Field Tilt (Наклон поля)
        - **Испания :** 64%
        - **Аргентина :** 51%
        - *Вывод:* Испания тотально доминирует на чужой трети поля, зажимая соперников в позиционную оборону.

        ### 🔑 Точность передач (Pass Completion %)
        - **Испания :** 89.5% (Родри лично: 93%)
        - **Аргентина :** 86.4%
        - *Вывод:* Испанцы хладнокровнее и качественнее держат мяч под интенсивным давлением.

        ### 🛑 PPDA (Интенсивность прессинга)
        - **Испания :** 8.2
        - **Аргентина :** 11.4
        - *Вывод:* Испания прессингует значительно агрессивнее и возвращает мяч гораздо быстрее в средних и высоких зонах.

        ### 🛡️ Успешность прессинг-действий (Successful Pressures %)
        - **Испания :** 36%
        - **Аргентина :** 29%
        - *Вывод:* Командные прессинг-ловушки Луиса де ла Фуэнте работают эффективнее.

        ### 📈 Метрики вклада действий (PV / VAEP)
        - **Испания :** Пик через фланги (Уильямс / Ямаль)
        - **Аргентина :** Пик через центр (Месси / Энцо Фернандес)
        - *Вывод:* Испания доставит мяч в штрафную через ширину поля, Аргентина — через тонкие проникающие пасы по центру.

        ## 3) Расчет матча методом Пуассона
        Для расчета взяты скорректированные показатели ожидаемых голов с учетом пропущенных мячей и силы оппонентов
        - Математическое ожидание голов Испании:  1.45$ (с поправкой на финал и закрытость игры).
        - Математическое ожидание голов Аргентины:  0.95$ (с учетом индивидуального фактора Месси и стандартов).

        ## Вероятности точных счетов (90 минут)
        Счет | Вероятность
        --- | ---
        1:1 (Ничья) | **~14.5%**
        1:0 в пользу Испании | **~13.8%**
        2:1 в пользу Испании | **~10.0%**
        2:0 в пользу Испании | **~10.0%**
        0:1 в пользу Аргентины | **~9.1%**

        - Вероятность победы Испании в основное время: **44%**
        - Вероятность ничьей в основное время: **31%**
        - Вероятность победы Аргентины в основное время: **25%**

        ## 4) Поиск VALUE в букмекерской линии
        Букмекерская линия на основное время (90 минут):
        - Победа Испании (П1) — **2.30** (Вероятность БК: 43.4% vs Модель: 44%)  Валуя нет.
        - Ничья (Х) — **3.00** (Вероятность БК: 33.3% vs Модель: 31%)  Валуя нет.
        - Победа Аргентины (П2) — **3.25** (Вероятность БК: 30.7% vs Модель: 25%)  Валуя нет.

        **Где сидит скрытый VALUE?**
        - **Тотал Меньше (2.5) голов за 1.65** (Вероятность БК: 60%). Финал — это битва нервов и осторожности. Оборона Испании пропустила всего 1 гол за весь турнир. Математическая модель оценивает вероятность ТМ 2.5 на уровне **68%** (честный кэф должен быть 1.47). Чистейший валуй.
        - **Аргентина ИТМ (1.0) за 1.80.** Южноамериканцы много забивали командам уровня Египта или нестабильной Швейцарии. Пробить лучшую оборону Европы с Родри во главе невероятно тяжело. Модель оценивает вероятность того, что Аргентина забьет максимум 1 гол (или уйдет без забитых мячей), в **76%**.

        ## 5) Анализ общей информации
        Испания представляет собой безупречно отлаженный системный механизм. Их прессинг (PPDA 8.2) будет провоцировать ошибки Аргентины на выходе из обороны. С другой стороны, аргентинцы обладают колоссальным опытом игры под прессингом. Ключевой зоной противостояния станет дуэль Родри против Месси перед испанской штрафной. Если Родри перекроет кислород Лео, атака Аргентины потеряет свой креативный центр. Учитывая фактор усталости Аргентины, шансы Испании выглядят предпочтительнее за пределами первого тайма.

        ## 6) Лучшие ставки на финал
        - **Основной выбор (VALUE):** Тотал голов Меньше 2.5 за коэффициент **1.65**. (Запредельное напряжение финала, феноменально надежная оборона Испании и прагматизм Скалони в решающих играх).
        - **Смелый выбор (Value):** Испания выиграет трофей за коэффициент **1.61**. (Глубина состава испанцев, отсутствие овертаймов в их сетке плей-офф и тактическое доминирование в опорной зоне предопределят исход противостояния).
        - **Статистический маркет:** Тотал желтых карточек Аргентины Больше 2.0. (Противодействие взрывным флангам в лице Ямаля и Уильямса потребует от защитников Аргентины постоянных тактических фолов на скорости).`
